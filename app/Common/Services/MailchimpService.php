...
class MailchimpService
{
	public function __construct()
	{
		...
		$mailchimp_credentials = get_onesignel_credential();

		if (isset($mailchimp_credentials) && is_array($mailchimp_credentials) && isset($mailchimp_credentials['mailchimp_api_key']) && isset($mailchimp_credentials['mailchimp_list_id'])) 
		{
			$this->apiKey     = $mailchimp_credentials['mailchimp_api_key'];
			$this->listId     = $mailchimp_credentials['mailchimp_list_id'];
