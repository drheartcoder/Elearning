...
class FlyerController extends Controller
{
	...
	public function __construct(FlyerModel $flyer_model)
	{
		$this->arr_view_data           = [];
		
		$this->admin_panel_slug   = config('app.project.admin_panel_slug');
		$this->admin_url_path     = url(config('app.project.admin_panel_slug'));
		$this->module_url_path    = $this->admin_url_path."/flyer";
		$this->module_title       = "Flyer";
		$this->module_view_folder = "admin.flyer";
		$this->module_icon        = "fa fa fa-envelope-square";
		$this->BaseModel          = $flyer_model;
