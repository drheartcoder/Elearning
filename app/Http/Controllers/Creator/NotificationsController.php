...
class NotificationsController extends Controller
{
	...
	public function __construct(NotificationsModel $notifications_model)
	{
		...
		$this->module_url_path    = $this->creator_url_path."/notifications";
		$this->module_title       = "Notification";
		$this->module_view_folder = "creator.notifications";
    ...
    */
	...
	public function index()
	{
		...
		$this->arr_view_data['parent_module_url']    = $this->creator_url_path.'/dashboard';
    ...
    */
	...
	public function read()
	{
		$login_user_id = '';
		$login_user_id = login_user_id('creator');		
        if(isset($login_user_id) && $login_user_id==true)
        {        	
        	$notification_count = $this->BaseModel->where('to_user_id',$login_user_id)->where('is_read','0')->count();         	
