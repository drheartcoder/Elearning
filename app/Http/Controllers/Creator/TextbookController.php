...
class TextbookController extends Controller
{
   use MultiActionTrait;
                                ...
                                )
	{
        ...
        $this->module_view_folder            = "creator.program.textbook";
        $this->admin_url_path                = url(config('app.project.creator_panel_slug'));
        $this->creator_panel_slug              = config('app.project.creator_panel_slug');
        $this->module_url_path               = url(config('app.project.creator_panel_slug')."/program/material/");
    ...
    public function load_data($program_id='',Request $request)
    {
        ...
        $obj_data = $this->TextbookModel->where('subject_id', '=', $arrProgramInfo['subject'])
                                        ->with([
    ...
    public function edit($program_id = '',$enc_id = '')
    {
        ...
        $this->arr_view_data['sub_module_title']             = 'Edit Textbook';
    ...
    public function update($program_id = '',$enc_id = '',Request $request)
    {
        ...
        $statusTextbookModel = $this->TextbookModel->where('id', '=', $textbookId)->update(['name'=>$request->input('textbookName'), 'slug'=>$slug]);
	...
	public function textbook_create($subject_id,$grade_id,$program_id,$lesson_id)
	{
		...
		return view($this->module_view_folder.'.textbook_create',$this->arr_view_data);
	}
	...
	public function store(Request $request)
	{
        ...
        $arr_rules['subject_id'] 	 = "required";
        $arr_rules['grade_id']   	 = "required";
        $arr_rules['program_id']   	 = "required";
        $arr_rules['lesson_id']   	 = "required";
        $arr_rules['textbookName']   = "required";
        ...
        return redirect($this->program_module_url_path.'/material/'.base64_encode($program_id));
	}
}