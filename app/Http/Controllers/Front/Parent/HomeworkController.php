...
class HomeworkController extends Controller
{
    ...
    public function HomeworkList(Request $request, $enc_program_id = false)
    {
        $arr_homework  = $arr_pagination = $arr_subject = $arr_grade = $arr_program = $arr_lesson = $arr_stud_lesson = $arr_student_programs = $arr_kid_id = $arr_programs_id = $arr_lesson_id = [];
        $subject_id    = $grade_id       = $program_id  = $lesson_id = '';
        $reset_link    = url('/').'/parent/homework';
        ...
        $obj_homework = $this->HomeworkimagesModel->with(['homeworkData' => function($query) use ($arr_programs_id, $arr_lesson_id) {
                                                  ...
                                                  ->whereHas("homeworkData.program_assign_by", function($query) use($user_id) {
                                                    $query->where('assigned_by','parent');
        ...
        if($enc_program_id != '' && !empty($enc_program_id))
        {
            ...
            $reset_link    = url('/').'/parent/homework/'.$enc_program_id;
        ...
        $data['middleContent']                 = 'parent.homework.index';
