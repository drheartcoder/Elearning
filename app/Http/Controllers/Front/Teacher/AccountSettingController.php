...
class AccountSettingController extends Controller
{
    ...
    */
    ...
    public function MyProfile()
    {
        ...
        $data['middleContent']                 = 'teacher.account-setting.my-profile';
    ...
    */
    ...
    public function UpdateProfile(Request $request)
    {
        ...
        $obj_data = $this->UsersModel->where('user_type', 'teacher')->where('id',$user_id)->update($arr_data);
        if($obj_data)
        {
            ...
            $arr_noti['url']          = "/teacher/account-setting/my-profile";
            $arr_noti['is_read']      = "0";
    ...
    /*
    | Function  : Teacher Change Password
    | Author    : Deepak Arvind Salunke
    | Date      : 03/07/2018
    | Output    : Show Page
    */
    ...
    public function ChangePassword()
    {
        ...
        $data['middleContent'] = 'teacher.account-setting.change-password';
    ...
    /*
    | Function  : Teacher Update Password
    | Author    : Deepak Arvind Salunke
    | Date      : 03/07/2018
    ...
    */
    ...
    public function RequestOTP(Request $request)
    {
        ...
        Session::put('new_phone_code',$phone_code_id);
        $message       = 'Your mobile number verification OTP : '.$otp_code;
        ...
        redirect(url('/teacher/account-setting/otp_verify'));
    ...
    */
    ...
    public function VerifyOTP()
    {
        ...
        $data['middleContent'] = 'teacher.account-setting.otp';
    ...
    */
    ...
    public function ProcessVerifyOTP(Request $request)
    {
        ...
        if($count > 0)
        {
            ...
            $arr_data['phone_code']          = Session::get('new_phone_code');
            ...
            return redirect( url('/teacher/account-setting/my-profile') );
        }
        else
        {
