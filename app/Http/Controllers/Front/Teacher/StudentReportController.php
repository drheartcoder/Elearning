...
class StudentReportController extends Controller
{
    ...
    {
      $this->module_url_path             = url('/').'/'.config('app.project.teacher_panel_slug');
    ...
    public function index($enc_class_id,$enc_student_id,$type='weekly',$selected_year=false)
    { 
          $student_id = '';
          $arr_programs   = $arr_year_range = $arr_program_count = $arr_student = $data=[];
          if(isset($enc_student_id) && $enc_student_id!="")
          {
            ...
            $data['pageTitle']               = trans('teacher.student_report');
            $data['middleContent']           = 'teacher.student_report';
            $data['user_type']               = 'teacher';
            $data['parentTitle']             = trans('teacher.student_report');
            $data['pageTitle']               = trans('teacher.student_report');
