...
class HomeworkController extends Controller
{
                                ...
                                )
	{
        ...
        $this->module_view_folder            = "supervisor.program.homework";
        $this->admin_url_path                = url(config('app.project.admin_panel_slug'));
        $this->admin_panel_slug              = config('app.project.admin_panel_slug');
        $this->module_url_path               = url(config('app.project.supervisor_panel_slug')."/program/homework/");
    ...
    public function update($program_id = '',$enc_id = '',Request $request)
    {
        ...
        /*$isNameExist = $this->HomeworkModel->where('id', '<>', $textbookId)->where('program_id', '=', $programId)->where('name', '=', $request->input('textbookName'))->count();*/
