! function() {
    ...
    n = "faa75404-3b97-5585-b449-4bc51338fbd1", t = (/^http:/.test(o.location) ? "http" : "https") + "://buttons.github.io/", e = function(e) {
        t = e
    }, a = !{}.hasOwnProperty.call(o, "currentScript") && o.currentScript && delete o.currentScript && o.currentScript ? o.currentScript.src : void 0;
    var s, h, u;
    s = function(t, e, n) {
        ...
        var e, n;
        /m/.test(o.readyState) || !/g/.test(o.readyState) && !o.documentElement.doScroll ? setTimeout(t) : o.addEventListener ? (n = 0, h(o, "DOMContentLoaded", e = function() {
            !n && (n = 1) && t()
    ...
    p = function(t, e) {
        ...
        window.$ = function() {
            ...
            n(200 !== d.status, JSON.parse(d.responseText))
        }), d.open("GET", t), d.send()) : (window._ = function(t) {
            window._ = null, n(200 !== t.meta.status, t.data)
        }, (l = c("script")).async = !0, l.src = t + (/\?/.test(t) ? "&" : "?") + "callback=_", s(l, "error", r = function() {
            window._ && _({
                meta: {}
            })
        }), l.readyState && s(l, "readystatechange", function() {
            "loaded" === l.readyState && r()
        }), a = o.getElementsByTagName("head")[0], "[object Opera]" === {}.toString.call(window.opera) ? u(function() {
            a.appendChild(l)
        }) : a.appendChild(l))
    }, m = function(t) {
        var e, n, a, o;
        "github.com" === t.hostname && (a = t.pathname.replace(/^(?!\/)/, "/").match(/^\/([^\/?#]+)(?:\/([^\/?#]+)(?:\/(?:(subscription)|(fork)|(issues)|([^\/?#]+)))?)?(?:[\/?#]|$)/)) && !a[6] && (a[2] ? (e = "repos/" + a[1] + "/" + a[2], a[3] ? (o = "subscribers_count", n = "watchers") : a[4] ? (o = "forks_count", n = "network") : a[5] ? (o = "open_issues_count", n = "issues") : (o = "stargazers_count", n = "stargazers")) : (e = "users/" + a[1], n = o = "followers"), g("https://api.github.com/" + e, function(e, a) {
            var i, r;
            e || (r = a[o], (i = c("a")).href = a.html_url + "/" + n, i.className = "social-count", i.setAttribute("aria-label", r + " " + o.replace(/_count$/, "").replace("_", " ") + " on GitHub"), i.appendChild(c("b")), i.appendChild(c("i")), i.appendChild(c("span")).appendChild(d(("" + r).replace(/\B(?=(\d{3})+(?!\d))/g, ","))), t.parentNode.insertBefore(i, t.nextSibling))
        }))
    }, w = function(t) {
        var e;
        t && (/^large$/i.test(t["data-size"]) && (o.body.className = "large"), e = f(t), /^(true|1)$/i.test(t["data-show-count"]) && m(e))
    };
    var v, y, C, z, x, E;
    y = window.devicePixelRatio || 1, v = function(t) {
        return (y > 1 ? l.ceil(l.round(t * y) / y * 2) / 2 : l.ceil(t)) || 0
    }, C = function(t) {
        var e, n, a, o, i, r, c;
        return r = (a = t.contentWindow.document).documentElement, e = a.body, c = r.scrollWidth, i = r.scrollHeight, e.getBoundingClientRect && (o = e.style.display, e.style.display = "inline-block", n = e.getBoundingClientRect(), c = l.max(c, v(n.width || n.right - n.left)), i = l.max(i, v(n.height || n.bottom - n.top)), e.style.display = o), [c, i]
    }, z = function(t, e) {
        t.style.width = e[0] + "px", t.style.height = e[1] + "px"
    }, x = function() {
        var t, e, n, a, i, r, l;
        if (e = [], o.querySelectorAll) e = o.querySelectorAll("a.github-button");
        else
            for (n = 0, i = (l = o.getElementsByTagName("a")).length; n < i; n++) ~(" " + (t = l[n]).className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" github-button ") && e.push(t);
        for (a = 0, r = e.length; a < r; a++) t = e[a], E(t)
    }, E = function(e, a) {
        var r, l, d, s, u, p, f, g;
        if (null == e) return x();
        for (s in null == a && (a = function(t) {
                var e, n, a, o, i, r;
                for (i = {
                        href: t.href,
                        title: t.title,
                        "aria-label": t.getAttribute("aria-label")
                    }, a = 0, o = (r = ["icon", "text", "size", "show-count"]).length; a < o; a++) i[e = "data-" + (e = r[a])] = t.getAttribute(e);
                return null == i["data-text"] && (i["data-text"] = t.textContent || t.innerText), (n = function(e, n, a) {
                ...
                var e, n, a;
                for (e in n = [], t) null != (a = t[e]) && n.push(i(e) + "=" + i(a));
                return n.join("&")
            }(a), d = c("iframe"), p = {
                allowtransparency: !0,
                scrolling: "no",
                frameBorder: 0
            }) g = p[s], d.setAttribute(s, g);
        z(d, [1, 0]), d.style.border = "none", d.src = "javascript:0", (f = a.title) && (d.title = f), o.body.appendChild(d), u = function() {
            var n;
            n = C(d), d.parentNode.removeChild(d), h(d, "load", function() {
                z(d, n)
            }), d.src = t + "buttons.html" + l, e.parentNode.replaceChild(d, e)
        }, h(d, "load", function() {
            var t;
            (t = d.contentWindow).$ ? t.$ = u : u()
        }), (r = d.contentWindow.document).open().write('<!DOCTYPE html><html><head><meta charset="utf-8"><title>' + n + '</title><link rel="stylesheet" href="' + SITE_URL + '/css/admin/buttons.css"><script>document.location.hash = "' + l + '";<\/script></head><body><script src="' + t + 'buttons.js"><\/script></body></html>'), r.close()
    }, "function" == typeof define && define.amd ? define([], {
        render: E
    }) : "object" == typeof exports && "string" != typeof exports.nodeName ? exports.render = E : (a && e(a.replace(/[^\/]*([?#].*)?$/, "")), o.title === n ? w(function(t) {
        var e, n, a, o, i, l;
        for (o = {}, e = 0, n = (l = t.split("&")).length; e < n; e++) "" !== (a = l[e]) && "" !== (i = a.split("="))[0] && (o[r(i[0])] = r(i.slice(1).join("=")));
        return o
