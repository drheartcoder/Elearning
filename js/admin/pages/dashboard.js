...
$(function() {    
    ...
    function trafficSources(element, height) {
        ...
        d3.csv("web_admin/assets/demo_data/dashboard/traffic_sources.csv", function (error, data) {
    ...
    function appSalesLines(element, height) {
        ...
        d3.csv("web_admin/assets/demo_data/dashboard/app_sales.csv", function(error, data) {
            formatted = data;
            redraw();
        });
