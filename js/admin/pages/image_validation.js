function validateImage (files,height,width) 
{
  ...
  if (typeof files !== "undefined") 
  {
    for (var i=0, l=files.length; i<l; i++) 
    {
          ...
          { 
            swal({                                      
            text: "Sorry, " + files[0]['name'] + " is invalid, allowed extensions are: jpeg , jpg , png.",
            type: 'warning',
          ...
          {   
           ...
           {
                swal({                                      
                text: "Image size should be upto 2 MB only.",
                type: 'warning',
                confirmButtonText: 'Ok',
                confirmButtonColor: "#e91e63"});
                      ...
                      $(".fileupload-preview").html("");
                        ...
                        image.onload = function () 
                        {
                            ...
                            if (height < image_height || width < image_width ) 
                            {
                                ...
                                {
                                      file_url = $('#default_image').val();
                                }
                                swal({                                      
                                      text: "Height and Width must be greater than or equal to "+image_height+" X "+image_width+".",
                                      type: 'warning',
                                      confirmButtonText: 'Ok',
                                      confirmButtonColor: "#e91e63"});
