...
function AnalogClock(id, option) {
	...
	this.c_minutes = option.c_minutes ? option.c_minutes : 0;
	this.c_hours   = option.c_hours ? option.c_hours : 0;
	...
	//this.panel.style.border = "solid 1px #000";
	...
	hour.style.borderTop = "solid " + (this.width * 0.5 - hourTop) + "px #000";
	...
	min.style.borderTop = "solid " + (this.width * 0.5 - minTop) + "px #000";
	...
	//start the clock (the animation part)
		...
		if((this.c_minutes!=undefined && this.c_hours!=undefined ) && (this.c_hours!=0))
		{
			var roS = 1.0 * 360 / 60 * 0;
			var roM = 1.0 * 360 / 60 * this.c_minutes;
			var roH = 1.0 * 360 / 12 * (this.c_hours % 12) + 1.0 * 360 / 12 * (this.c_minutes / 60);
			/*sec.style.transform = 'rotate(' + roS + 'deg)';*/
			min.style.transform = 'rotate(' + roM + 'deg)';
			hour.style.transform = 'rotate(' + roH + 'deg)';
		}
/*		if((this.c2_minutes!=undefined && this.c2_hours!=undefined ) && (this.c2_hours!=0))
		{
			var roS = 1.0 * 360 / 60 * 0;
			var roM = 1.0 * 360 / 60 * this.c2_minutes;
			var roH = 1.0 * 360 / 12 * (this.c2_hours % 12) + 1.0 * 360 / 12 * (this.c2_minutes / 60);
			sec.style.transform = 'rotate(' + roS + 'deg)';
			min.style.transform = 'rotate(' + roM + 'deg)';
			hour.style.transform = 'rotate(' + roH + 'deg)';
		}
