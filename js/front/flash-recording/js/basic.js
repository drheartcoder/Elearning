$(function () {
  ...
  var appWidth = 24;
  var appHeight = 24;
  var flashvars = {'upload_image': SITE_URL+'/js/front/flash-recording/images/upload.png'};
  var params = {};
  var attributes = {'id': RECORDER_APP_ID, 'name': RECORDER_APP_ID};
  swfobject.embedSWF(SITE_URL+"/js/front/flash-recording/js/recorder.swf", "flashcontent", appWidth, appHeight, "11.0.0", "", flashvars, params, attributes);
