                  ...
                  <form class="form-horizontal" id="frm_account_setting" name="frm_account_setting" action="{{$module_url_path}}/profile_update" method="post" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <!-- <div class="fileinput fileinput-new text-center profile-img-block" data-provides="fileinput"> -->
                              ...
                              <div class="profile-img-up fileinput-new thumbnail img-circle">
                              	...
                              	@php $is_profile_image_required = $prev_image_url = ""; @endphp
			                        ...
			                        @if(isset($arr_admin_details['profile_image']) && !empty($arr_admin_details['profile_image']) && File::exists($profile_image_base_img_path.$arr_admin_details['profile_image']))
			                            <img src="{{$profile_image_public_img_path.$arr_admin_details['profile_image']}}"  style="max-width: 100%; max-height: 100%; line-height: 20px;width: 100%;height: 100%" class="fileupload-preview">
			                            @php 
...
<!--
                                 ...
                                 <span class="fileinput-exists">Change</span>
                                 <input type="file" data-validation-allowing="jpg, png, gif" class="jai" name="profile_image" id="profile_image"  {{$is_profile_image_required == true ? 'data-rule-required=true' : ''}} data-msg-required="Please select profile image."/>
                                 </span>
-->
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="user_name" id="user_name" class="form-control" data-rule-required="true" data-rule-alphanumeric="true" data-rule-maxlength="60" value="{{$arr_admin_details['user_name'] or ''}}">
                           </div>
                        </div>
                        <div class="col-md-6">
                        	<input type="hidden" name="isvalid" id="isvalid" value="">	
							           <input type="hidden" name="user_id" id="user_id" value="{{base64_encode($arr_admin_details['id'])}}">		
                           <div class="form-group">
                              <label class="bmd-label-floating">Email address <i class="red">*</i></label>
                              <input type="email" class="form-control chk_email" name="email" id="email" data-rule-required="true" data-rule-email value="{{$arr_admin_details['email'] or ''}}">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="first_name" id="first_name" data-rule-required="true" data-rule-maxlength="60" value="{{$arr_admin_details['first_name'] or ''}}" onkeyup="chk_validation(this)">                              
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="last_name" id="last_name" data-rule-required="true" data-rule-maxlength="60" value="{{$arr_admin_details['last_name'] or ''}}" onkeyup="chk_validation(this)">
                     ...
                     <div class="row">
                            ...
                            <select id="phone_code" data-rule-required="true" class="form-control" name="phone_code">
                                ...
                                @foreach($arr_phone_code as $phone_code)
                                 @if(isset($phone_code['nicename']) && $phone_code['nicename']!="")
                                      <option @if(isset($arr_admin_details['phone_code']) && $arr_admin_details['phone_code']==$phone_code['id']) selected="" @endif value="{{ $phone_code['id'] }}"> ({{ $phone_code['nicename'] }}) +{{ $phone_code['phonecode'] }}</option>
                                 @endif
                                @endforeach
                        ...
                        @endif
                         ...
                         <div class="col-md-6">
                           <div class="form-group">
                              <label class="bmd-label-floating">Mobile Number <i class="red">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="bmd-label-floating">Fax Number </label>
                              <input type="text" class="form-control" name="fax_number" id="fax_number" value="{{$arr_admin_details['fax_number'] or ''}}">
                              <span class="has-danger">{{ $errors->first('fax_number') }} </span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="bmd-label-floating">Address/Zip </label>
                              <input type="text" class="form-control" name="address" id="address" placeholder="" value="{{$arr_admin_details['address'] or ''}}">
