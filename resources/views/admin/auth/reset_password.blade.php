			...
			<div class="page-header login-page header-filter" filter-color="black" style="background-image: url('../assets/img/class9.JPG'); background-size: cover; background-position: top center;">
				<div class="container">
					<div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
						<form action="{{url('/')}}/admin/forgot_password/postReset" method="post" id="frm_forgot" class="form form-validate">
						{{csrf_field()}}
							...
							<div class="card card-login card-hidden">
								...
								<div class="back-to-login">
                                    <a href="{{url('/')}}/admin" class="btn btn-rose btn-link btn-lg">Back To Login</a>
                                </div>
							</div>
						</form>
					</div>
