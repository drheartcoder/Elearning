...
<!--                <h4 class="title"></h4>-->
				<div class="row">
                    <div class="col-md-4">
                       <div class="form-group has-default bmd-form-group is-filled">
                          ...
                          <input type="text" name="name" id="name"  class="form-control" data-rule-required="true" data-rule-maxlength="60" value="{{$name or ''}}">
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group has-default bmd-form-group is-filled">
                            <label class="bmd-label-floating">Code </label>
                          <input type="text" name="code" id="code"  class="form-control" data-rule-required="true" data-rule-maxlength="60" value="{{$code or ''}}">
                       </div>
                    </div>
                    <div class="col-md-4">
            ...
            {{csrf_field()}}	
	          ...
	          <div class="toolbar">            
	            ...
	            <a href="{{ $module_url_path.'/rate-manage' }}" class="btn btn-link btn-info btn-just-icon like" title="Currency Rate Manage"><i class="fa fa-money"></i></a>
