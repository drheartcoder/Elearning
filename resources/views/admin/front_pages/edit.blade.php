                ...
                <div class="card">
                  ...
                  <h4 class="card-title">{{$module_title or ''}}
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" id="frm_create_front_page" name="frm_create_front_page" action="{{$module_url_path}}/update/{{isset($id) ? $id : ''}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <h4 class="title"></h4>
                                ...
                                <div class="tab-pane {{ $lang['locale']=='en'?'active':'' }}" id="{{ $lang['locale'] }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                ...
                                                <input type="text" name="page_name_{{$lang['locale']}}" id="page_name_{{$lang['locale']}}" class="form-control" data-rule-required="true" data-rule-maxlength="100" value="{{ isset($page_details['translations'][$lang['locale']]['name']) ? $page_details['translations'][$lang['locale']]['name']:'' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                ...
                                                <input type="text" class="form-control" name="title_{{$lang['locale']}}" id="title_{{$lang['locale']}}" data-rule-required="true" data-rule-maxlength="100" value="{{ isset($page_details['translations'][$lang['locale']]['title']) ? $page_details['translations'][$lang['locale']]['title']:'' }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                ...
                                                <input type="text" class="form-control" name="meta_title_{{$lang['locale']}}" id="meta_title_{{$lang['locale']}}" data-rule-required="true" data-rule-maxlength="100" value="{{ isset($page_details['translations'][$lang['locale']]['meta_title']) ? $page_details['translations'][$lang['locale']]['meta_title'] : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                ...
                                                <input type="text" class="form-control" name="meta_keyword_{{$lang['locale']}}" id="meta_keyword_{{$lang['locale']}}" data-rule-required="true" data-rule-maxlength="100" value="{{ isset($page_details['translations'][$lang['locale']]['meta_keyword']) ? $page_details['translations'][$lang['locale']]['meta_keyword']:'' }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                ...
                                                <textarea class="form-control" name="meta_description_{{$lang['locale']}}" id="meta_description_{{$lang['locale']}}" data-rule-required="true"> {{ isset($page_details['translations'][$lang['locale']]['meta_description']) ? $page_details['translations'][$lang['locale']]['meta_description']:'' }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group has-default bmd-form-group is-filled">
                                                <textarea class="ckeditor page_description" data-attr='textarea' name="page_description_{{$lang['locale']}}" id="page_description_{{$lang['locale']}}" rows="15" data-rule-required="true">{{ isset($page_details['translations'][$lang['locale']]['description']) ? $page_details['translations'][$lang['locale']]['description']:'' }}</textarea>
