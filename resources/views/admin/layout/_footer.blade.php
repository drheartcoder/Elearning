            <footer class="footer" >
               <div class="container-fluid">                  
                  <div class="copyright float-right">                    
                    {{date('Y')}} © {{ config('app.project.name') }} {{ ucfirst($shared_admin_details['user_type']) }}                    
                  </div>
               </div>
            </footer>
         </div>
      ...
      <!-- <script src="{{url('/')}}/js/admin/daterangepicker/daterangepicker.css"></script>      
      <script src="{{url('/')}}/js/admin/daterangepicker/daterangepicker.js"></script>      -->
