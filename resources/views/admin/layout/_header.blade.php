...
<html lang="en">
   ...
   <head>
      ...
      <!-- Ui Datepicker -->
      <link rel = "stylesheet" href = "{{url('/')}}/css/admin/ui-datepicker/jquery-ui.css">    
      ...
      <!-- Ui Datepicker -->
      <!-- <script type = "text/javascript" src = "{{url('/')}}/js/admin/ui-datepicker/jquery.min.js"></script> -->
      <script type = "text/javascript" src = "{{url('/')}}/js/admin/ui-datepicker/jquery-ui.min.js"></script>
...
<!--       <script src="https://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyCccvQtzVx4aAt05YnfzJDSWEzPiVnNVsY&libraries=places"></script>
      <script type="text/javascript" src="{{url('/')}}/js/admin/pages/jquery.geocomplete.js"></script> -->
	  <!--script for tabbing-->
      <script type="text/javascript" src="{{url('/')}}/js/admin/responsivetabs.js"></script>
      <input type="hidden" value="{{ csrf_token() }}" name="token" id="token">
      <script type="text/javascript">
         var SITE_URL       = "{{url('/')}}";
         var SITE_ADMIN_URL = "{{url('/')}}/"+"{{config('app.project.admin_panel_slug')}}";
         var csrf_token     = "{{ csrf_token() }}";
      </script>
      <script type="text/javascript">
         function logout(){
            sessionStorage.setItem('scroll_position',0);
            var logout_url = "{{ url('/').'/'.config('app.project.admin_panel_slug') }}/logout";
      ...
      <div class="wrapper ">
         <div class="sidebar" data-color="rose" data-background-color="black" data-image="{{url('/')}}/assets/img/sidebar-1.jpg">
            <!--
               ...
               -->
            <div class="logo"><a href="#" class="simple-text logo-mini"><img src="{{url('/favicon.ico')}}"></a>
                  ...
                  <div class="collapse navbar-collapse justify-content-end">
                     ...
                     <ul class="navbar-nav">                      
                        <li class="nav-item dropdown">
                           <a class="nav-link" href="{{url('/').'/'.$admin_path.'/notifications'}}">
                        ...
                        <li class="nav-item">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                              <a class="dropdown-item" href="{{url('/').'/'.$admin_path.'/account_setting/edit_profile'}}">Edit Profile</a>
                              <a class="dropdown-item" href="{{url('/').'/'.$admin_path.'/account_setting/password/change'}}">Change Password</a>
