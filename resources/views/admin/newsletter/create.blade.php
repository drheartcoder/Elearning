            ...
            <div class="card-body-section">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" id="frm_add_newsletter" name="frm_add_newsletter" action="{{$module_url_path}}/store" method="post">
                            {{csrf_field()}}
                            <h4 class="title"></h4> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-default bmd-form-group is-filled">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" data-rule-required="true" data-rule-maxlength="75" data-msg-maxlength="Please enter title" value="{{old('title')}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group has-default bmd-form-group is-filled">
                                        <input type="text" name="broadcast_date" id="broadcast_date" class="form-control datepicker" readonly="" data-rule-required="true" data-msg-required="Please select Boradcast Date." value="{{old('broadcast_date')}}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group has-default bmd-form-group is-filled">
                                        <textarea class="ckeditor message" data-attr='textarea' name="message" data-rule-maxlength="10000" id="message" rows="15"  data-rule-required="true"></textarea>
                                        <span class="error">{{ $errors->first('message') }} </span>
                                    </div>
                                </div>
                            </div>                                
                            <button type="submit" class="btn btn-rose pull-right btn_create_newsletter">Add</button>
