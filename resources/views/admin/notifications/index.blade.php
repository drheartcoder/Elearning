        ...
        <div class="card-body">
				...
				<div class="row">
                    <div class="col-md-6">
                       <div class="form-group has-default bmd-form-group is-filled">
                          ...
                          <span class="error">{{ $errors->first('search_keyword') }} </span>
                       </div>
                    </div>
                    <div class="col-md-6">
            ...
            {{csrf_field()}}	
	          ...
	          <div class="toolbar">            
	            ...
	            @if($shared_admin_details['user_type'] == 'admin' || ($arr_current_user_access!=null && count($arr_current_user_access)>0 && array_key_exists('notifications.delete', $arr_current_user_access)))
