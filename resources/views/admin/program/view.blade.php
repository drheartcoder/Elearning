        ...
        <div class="card">
          <div class="card-header card-header-icon card-header-rose">
           ...
           @if($student_assign_program==false || $arrProgram['approve_status']=='pending')
            <a class="btn btn-link btn-warning btn-just-icon like program-edit-btn" href="{{ $base_module_url_path.'/edit/'.base64_encode($arrProgram['id']) }}" title="Edit"><i class="material-icons" >create</i> <span>Edit</span></a> <div class="clearfix"></div>
          @endif
          </div>
          <div class="card-body">
            <!-- <div class="row"> -->
                <!-- <div class="col-sm-7 col-md-7 col-lg-7"> -->
                    <div class="program-details-main">
                        ...
                        <span>
                          <a style="float:right;" href="{{ $base_module_url_path.'/material/'.base64_encode($programId) }}" class="btn btn-fill btn-rose" > <i class="fa fa-eye"></i> Book</a>
