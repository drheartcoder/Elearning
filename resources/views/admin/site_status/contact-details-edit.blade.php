                  ...
                  <div class="tab-content tab-space">
                          ...
                          <div class="tab-pane {{ $lang['locale']=='en'?'active':'' }}" id="{{ $lang['locale'] }}">  
                            ...
                            <div class="form-group has-default bmd-form-group is-filled">
                                ...
                                <input type="text" name="site_address_{{ $lang['locale'] or '' }}" id="site_address_{{ $lang['locale'] or '' }}" placeholder="" class="form-control" data-rule-required="true" data-rule-maxlength="500" value="{{$arr_contact_address[$lang['locale']]['address'] or ''}}">
