            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php $subject_name = Request::input('subject_name'); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-default bmd-form-group is-filled">
                                            ...
                                            <input type="text" name="subject_name" id="subject_name" class="form-control" data-rule-required="true" data-rule-maxlength="60" value="{{$subject_name or ''}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <form class="form-horizontal" id="frm_manage" name="frm_manage" action="{{$module_url_path}}/multi_action" method="post">
                                ...
                                <div class="toolbar">
                                    ...
                                    @if(($arr_current_user_access!=null && count($arr_current_user_access)>0 && array_key_exists('subject.delete', $arr_current_user_access)) || $shared_admin_details['user_type'] == 'admin')
