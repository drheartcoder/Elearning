               ...
               <div class="card-body">
                  @include('admin.layout._operation_status')                  
                    <form class="form-horizontal" id="frm_create_front_page" name="frm_create_front_page" action="{{$module_url_path}}/update/{{isset($id) ? $id : ''}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="tab-pane {{ $lang['locale']=='en'?'active':'' }}" id="{{ $lang['locale'] }}">
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                   ...
                                   <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                      ...
                                      @if(isset($arr_testimonials['image']) && !empty($arr_testimonials['image']) && File::exists($testimonials_image_base_path.$arr_testimonials['image']))
                                          <img src="{{$testimonials_image_public_path.$arr_testimonials['image']}}"  style="max-width: 100%; max-height: 100%; line-height: 20px;width: 100%;height: 100%" class="fileupload-preview">
                                          @php 
                                            $prev_image_url = $testimonials_image_public_path.$arr_testimonials['image']; 
                                      ...
                                      <div>
                                         ...
                                         <input type="file"  data-validation-allowing="jpg, png, gif" class="file-input news-image validate-image" name="testimonial_image_{{$lang['locale']}}" id="image_1"  {{$is_image_required == true ? 'data-rule-required=true' : ''}} data-msg-required="Please select image."><br>
                                          
                                          <input type="hidden" name="oldimage" id="oldimage" value="{{ $arr_testimonials['image']}}"/>
                                          <input type="hidden" name="prev_image_url" id="prev_image_url" value="{{$prev_image_url or ''}}"/>
                                         </span>
                                         <div class="clearfix"></div>
                                         <a href="javascript:void(0)" class="btn btn-danger fileinput-exists" data-dismiss="fileinput" id="remove"><i class="fa fa-times"></i> Remove</a>
                                      </div>                              
                                   </div> 
                                   <div class="clearfix"></div>                  
                           ...
                           <div class="form-group has-default bmd-form-group is-filled">
                            <label class="bmd-label-floating">Name <i class="red">*</i></label>
                                <input type="text" class="form-control" name="testimonial_name_{{$lang['locale']}}" id="testimonial_name_{{$lang['locale']}}" data-rule-required="true"  data-rule-maxlength="250" value="{{ isset($arr_testimonials['translations'][$lang['locale']]['title']) ? $arr_testimonials['translations'][$lang['locale']]['title']:'' }}">
                           ...
                           <div class="form-group has-default bmd-form-group is-filled">
                              <textarea class="ckeditor message" data-attr='textarea' name="message_{{$lang['locale']}}" id="message_{{$lang['locale']}}" rows="15"  data-rule-required="true">{{ isset($arr_testimonials['translations'][$lang['locale']]['message']) ? $arr_testimonials['translations'][$lang['locale']]['message']:'' }}</textarea>
                       ...
                       <button type="submit" class="btn btn-rose pull-right btn_add_testimonial">Update</button>
