...
<div class="content">
    <div class="card-body-section">  
       <div class="card">
            ...
            <input type="hidden" id="teacher_id" name="teacher_id" value="{{ isset($arr_data['id']) ? $arr_data['id'] : '' }}">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              <div class="card-icon">
                <i class="{{ $classes_module_icon or ''}}"> </i>
              </div>
              <h4 class="card-title">{{ $classes_module_title or '' }}</h4>
            </div>
            <div class="card-body">
                ...
                <form name="frm-manage" id="frm-manage" method="get" action="{{ $classes_module_url }}" class="form-horizontal" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{{ $classes_module_url }}" class="btn btn-default">Clear</a>
                        </div>
                    </div>
                </form> 
                <div class="clearfix"></div>

                <form class="form-horizontal" id="frm_manage" name="frm_manage" action="{{ $classes_module_url }}/multi_action" method="post">
                {{csrf_field()}}
                  ...
                  <div class="toolbar">
                    ...
                    <a href="{{ $classes_module_url }}" class="btn btn-link btn-primary btn-just-icon like" title="Refresh"><i class="material-icons">autorenew</i></a>
...
<script>
    $(document).ready(function() {
        ...
        var temp_url        = module_url_path + '/load-classes';
        ...
        $('#datatables').DataTable({
            ...
            {
                'url'  : temp_url,
                'data' : { 'keyword':keyword,'search_date':search_date, 'teacher_id':teacher_id }
            },
            "columnDefs" : [
