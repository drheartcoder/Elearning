                           ...
                           <div class="col-sm-6">
                              ...
                              <div style="position: relative;" class="form-group">
                                 <div class="profile-img-block temp-img-block">
                                    ...
                                    <span class="note-section-block"><b>Note :</b> <span>Allowed only jpg | jpeg | png, <br/> Upload image greater than or equal to 165 X 165 for best result.</span></span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer1" id="answer1" class="form-control classWord" value="{{ (isset($arrQuestion['answer1']) && $arrQuestion['answer1']!='') ? $arrQuestion['answer1'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer2" id="answer2" class="form-control classWord" value="{{ (isset($arrQuestion['answer2']) && $arrQuestion['answer2']!='') ? $arrQuestion['answer2'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer3" id="answer3" class="form-control classWord" value="{{ (isset($arrQuestion['answer3']) && $arrQuestion['answer3']!='') ? $arrQuestion['answer3'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer4" id="answer4" class="form-control classWord" value="{{ (isset($arrQuestion['answer4']) && $arrQuestion['answer4']!='') ? $arrQuestion['answer4'] : '' }}" >
                                 <span class="error" id="err_answer4"> @if($errors->has('answer4')) {{ $errors->first('answer4') }} @endif </span>
                              </div>
							   </div>
                           </div>
                           <div class="col-sm-6">
                              <label class="col-form-label">Question 5 File (Image) <span class="red">*</span></label>
                              <div style="position: relative;" class="form-group">
                                 <div class="profile-img-block temp-img-block">
                                    <div class="pro-img">
                                       <?php
                           ...
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer5" id="answer5" class="form-control classWord" value="{{ (isset($arrQuestion['answer5']) && $arrQuestion['answer5']!='') ? $arrQuestion['answer5'] : '' }}" >
                                 <span class="error" id="err_answer5"> @if($errors->has('answer5')) {{ $errors->first('answer5') }} @endif </span>
                              </div>
							   </div>
                           </div>
                           <div class="col-sm-6">
                              <label class="col-form-label">Question 6 File (Image) <span class="red">*</span></label>
                              <div style="position: relative;" class="form-group">
                                 <div class="profile-img-block temp-img-block">
                                    <div class="pro-img">
                                       <?php
                           ...
                           <div class="col-sm-6">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer6" id="answer6" class="form-control classWord" value="{{ (isset($arrQuestion['answer6']) && $arrQuestion['answer6']!='') ? $arrQuestion['answer6'] : '' }}" >
...
<script type="text/javascript">
   ...
   $('.imgFile').change(function(){
       ...
       imageSizeValidate(tempThis, files, '165', '165');
   });
