               ...
               <div class="card-body">
                  ...
                  <form name="frmUpdate" id="frmUpdate" method="post" action="{{ $module_url_path.'/update' }}" enctype="multipart/form-data">
                     ...
                     <div class="devSubWrapper">
                        <div class="row admin-template-15">
                           <div class="col-sm-12">
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="row">
                                 ...
                                 <div class="col-sm-12">
                                    <div id="divBlankLetterWrapper1" style="display: {{ (isset($arrQuestion['question_1_text']) && $arrQuestion['question_1_text']!='') ? 'block' : 'none' }};" >
                                       <label class="col-form-label">Fill the Letters <span class="red">*</span></label>
                                       <div class="form-group m-b-10" style="margin-top: 0 !important;">
                                          <div id="divBlankLetterSubWrapper1">
                                             <?php
                                                $arrQuestion1AnswerPosition = $arrQuestion1 = [];
                                                if(isset($arrQuestion['question_1_answer_position']));
                                                {
                                                  $arrQuestion1AnswerPosition = str_split($arrQuestion['question_1_answer_position']);
                                                }
                                                if(isset($arrQuestion['question_1_text']) && $arrQuestion['question_1_text']!='')
                                                {
                                                  $arrQuestion1 = str_split($arrQuestion['question_1_text']);
                                                }
                                                if(count($arrQuestion1) > 0)
                                                {
                                                  foreach ($arrQuestion1 as $arrQuestion1Key => $arrQuestion1Val)
                                                  {
                                                    $flagChecked = '';
                                                    if($arrQuestion1AnswerPosition[$arrQuestion1Key] == 0)
                                                    {
                                                      $flagChecked = 'checked';
                                                    }
                                                    ?>
                                             <div class="alphabate-letter-section">
                                                <input type="text" name="rdoQuestion1Text[]" class="form-control" maxlength="1" value="{{ $arrQuestion1Val }}" />
                                                <div class="radio-btns">
                                                   <div class="radio-btn radio-first-option">
                                                      <input type="radio" id="rdoQuestion1_{{ $arrQuestion1Key }}" name="rdoQuestion1" value="{{ $arrQuestion1Key }}" {{ $flagChecked }} >
                                                      <label for="rdoQuestion1_{{ $arrQuestion1Key }}">&nbsp;</label>
                                                      <div class="check"></div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <span class="error" id="err_rdoQuestion1"> @if($errors->has('rdoQuestion1')) {{ $errors->first('rdoQuestion1') }} @endif </span>
                                       </div>
                                       <div class="note-section-block form-note-section m-b-20"><b>Note :</b> <span>Please select a radion button which letter you want to hide</span></div>
                                    </div>
                                 </div>
                              </div>
							   </div>
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="row">
                                 ...
                                 <div class="col-sm-12">
                                    <div id="divBlankLetterWrapper2" style="display: {{ (isset($arrQuestion['question_2_text']) && $arrQuestion['question_2_text']!='') ? 'block' : 'none' }};" >
                                       <label class="col-form-label">Fill the Letters <span class="red">*</span></label>
                                       <div class="form-group m-b-10" style="margin-top: 0 !important;">
                                          <div id="divBlankLetterSubWrapper2">
                                             <?php
                                                $arrQuestion2AnswerPosition = $arrQuestion2 = [];
                                                if(isset($arrQuestion['question_2_answer_position']));
                                                {
                                                  $arrQuestion2AnswerPosition = str_split($arrQuestion['question_2_answer_position']);
                                                }
                                                if(isset($arrQuestion['question_2_text']) && $arrQuestion['question_2_text']!='')
                                                {
                                                  $arrQuestion2 = str_split($arrQuestion['question_2_text']);
                                                }
                                                if(count($arrQuestion2) > 0)
                                                {
                                                  foreach ($arrQuestion2 as $arrQuestion2Key => $arrQuestion2Val)
                                                  {
                                                    $flagChecked = '';
                                                    if($arrQuestion2AnswerPosition[$arrQuestion2Key] == 0)
                                                    {
                                                      $flagChecked = 'checked';
                                                    }
                                                    ?>
                                             <div class="alphabate-letter-section">
                                                <input type="text" name="rdoQuestion2Text[]" class="form-control" maxlength="1" value="{{ $arrQuestion2Val }}" />
                                                <div class="radio-btns">
                                                   <div class="radio-btn radio-first-option">
                                                      <input type="radio" id="rdoQuestion2_{{ $arrQuestion2Key }}" name="rdoQuestion2" value="{{ $arrQuestion2Key }}" {{ $flagChecked }} >
                                                      <label for="rdoQuestion2_{{ $arrQuestion2Key }}">&nbsp;</label>
                                                      <div class="check"></div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <div class="clearfix"></div>
                                          <span class="error" id="err_rdoQuestion2"> @if($errors->has('rdoQuestion2')) {{ $errors->first('rdoQuestion2') }} @endif </span>
                                       </div>
                                       <div class="note-section-block form-note-section m-b-20"><b>Note :</b> <span>Please select a radion button which letter you want to hide</span></div>
                                    </div>
                                 </div>
