                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer1" id="answer1" class="form-control classWord" value="{{ (isset($arrQuestion['question_1_answer']) && $arrQuestion['question_1_answer']!='') ? $arrQuestion['question_1_answer'] : '' }}" maxlength="45" >
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer2" id="answer2" class="form-control classWord" value="{{ (isset($arrQuestion['question_2_answer']) && $arrQuestion['question_2_answer']!='') ? $arrQuestion['question_2_answer'] : '' }}" maxlength="45" >
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer3" id="answer3" class="form-control classWord" value="{{ (isset($arrQuestion['question_3_answer']) && $arrQuestion['question_3_answer']!='') ? $arrQuestion['question_3_answer'] : '' }}" maxlength="45" >
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer4" id="answer4" class="form-control classWord" value="{{ (isset($arrQuestion['question_4_answer']) && $arrQuestion['question_4_answer']!='') ? $arrQuestion['question_4_answer'] : '' }}" maxlength="45" >
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer5" id="answer5" class="form-control classWord" value="{{ (isset($arrQuestion['question_5_answer']) && $arrQuestion['question_5_answer']!='') ? $arrQuestion['question_5_answer'] : '' }}" maxlength="45" >
                           ...
                           <div class="col-sm-8">
                             <div class="ques-text">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer6" id="answer6" class="form-control classWord" value="{{ (isset($arrQuestion['question_6_answer']) && $arrQuestion['question_6_answer']!='') ? $arrQuestion['question_6_answer'] : '' }}" maxlength="45" >
