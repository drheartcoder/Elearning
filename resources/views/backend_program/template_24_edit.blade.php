                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer4" id="answer4" class="form-control " value="{{ (isset($arrQuestion['answer_4']) && $arrQuestion['answer_4']!='') ? $arrQuestion['answer_4'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer5" id="answer5" class="form-control " value="{{ (isset($arrQuestion['answer_5']) && $arrQuestion['answer_5']!='') ? $arrQuestion['answer_5'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question6" id="question6" class="form-control " value="{{ (isset($arrQuestion['question_6']) && $arrQuestion['question_6']!='') ? $arrQuestion['question_6'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer6" id="answer6" class="form-control " value="{{ (isset($arrQuestion['answer_6']) && $arrQuestion['answer_6']!='') ? $arrQuestion['answer_6'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question7" id="question7" class="form-control " value="{{ (isset($arrQuestion['question_7']) && $arrQuestion['question_7']!='') ? $arrQuestion['question_7'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer7" id="answer7" class="form-control " value="{{ (isset($arrQuestion['answer_7']) && $arrQuestion['answer_7']!='') ? $arrQuestion['answer_7'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question8" id="question8" class="form-control " value="{{ (isset($arrQuestion['question_8']) && $arrQuestion['question_8']!='') ? $arrQuestion['question_8'] : '' }}" >
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer8" id="answer8" class="form-control " value="{{ (isset($arrQuestion['answer_8']) && $arrQuestion['answer_8']!='') ? $arrQuestion['answer_8'] : '' }}" >
