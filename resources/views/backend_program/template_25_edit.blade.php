                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <?php
                                       ...
                                       {
                                         if(file_exists($question_video_base_path.$arrQuestion['question_1_file']))
                                         {
                                           $videoUrl = $question_video_public_path.$arrQuestion['question_1_file'];
                                         }
                                       }
                                       if($videoUrl!='')
                                       {
                                 ...
                                 <div class="col-sm-8">
                                    <label class="bmd-label-floating col-form-label">Question File (Video) </label>
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <div class="form-group">
                                 ...
                                 <textarea name="question" id="question" class="form-control" style="height: 100px"  maxlength="320">{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}</textarea>
                                 <span class="error" id="err_question"> @if($errors->has('question')) {{ $errors->first('question') }} @endif </span>
                              </div>
                              <span class="note-section-block form-note-section mb20"><b>Note :</b> <span>Maximum 500 Characters are allowed</span></span>
                           </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="row">
