...
<div class="devSubWrapper">
   ...
   <div class="row">
      ...
      <div class="col-sm-3">
         <div class="form-group">
            <label class="bmd-label-floating">Option 1 (Word)<span class="red">*</span></label>
            <input type="text" name="option3_1" id="option3_1" class="form-control classWord" value="{{ old('option3_1') }}" >
      ...
      <div class="col-sm-3">
         <div class="form-group">
            <label class="bmd-label-floating">Option 2 (Word)<span class="red">*</span></label>
            <input type="text" name="option3_2" id="option3_2" class="form-control classWord" value="{{ old('option3_2') }}" >
      ...
      <div class="col-sm-3">
         <div class="form-group">
            <label class="bmd-label-floating">Option 3 (Word)<span class="red">*</span></label>
            <input type="text" name="option3_3" id="option3_3" class="form-control classWord" value="{{ old('option3_3') }}" >
   ...
   <div class="row" style="position: relative;">
      <div class="col-sm-3">
         <div class="radio-btns">
            <div class="radio-btn radio-first-option">
               <input type="radio" id="rdoOption3_1" name="rdoOption3" value="1">
      ...
      <div class="col-sm-3">
         <div class="radio-btns">
            <div class="radio-btn radio-first-option">
               <input type="radio" id="rdoOption3_2" name="rdoOption3" value="2">
      ...
      <div class="col-sm-3">
         <div class="radio-btns">
            <div class="radio-btn radio-first-option">
               <input type="radio" id="rdoOption3_3" name="rdoOption3" value="3">
               <label for="rdoOption3_3">Option 3</label>
               <div class="check"></div>
            </div>
         </div>
      </div>
      <span class="error" id="err_rdoOption3" style="left: 15px;bottom: -15px;"> @if($errors->has('rdoOption2')) {{ $errors->first('rdoOption2') }} @endif</span>        
   </div>
   <span class="note-section-block form-note-section" style="margin-top: 15px;"><b>Note :</b> <span><span>Select any one option which is correct answer</span></span></span>
   <div class="row">
      <div class="col-sm-6">
