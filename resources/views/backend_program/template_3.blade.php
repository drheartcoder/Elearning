<div class="devSubWrapper">
   ...
   <div class="row">
      <div class="col-sm-6">
         ...
         <div class="form-group">
            <label class="bmd-label-floating">Question 1 Text (Word)<span class="red">*</span></label>
      ...
      <div class="col-sm-6">
         ...
         <div style="position: relative;" class="form-group">
            <div class="profile-img-block temp-img-block">
               <div class="pro-img"><img src="{{ url('/') }}/images/default.jpg" id="imgFilePreview2" class="img-responsive img-preview imgFilePreview" alt=""/></div>
         ...
         <div class="form-group">
            <label class="bmd-label-floating">Question 2 Text (Word)<span class="red">*</span></label>
