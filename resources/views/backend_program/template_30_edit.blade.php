                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question1" id="question1" class="form-control " value="{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer1" id="answer1" class="form-control " value="{{ (isset($arrQuestion['answer_1']) && $arrQuestion['answer_1']!='') ? $arrQuestion['answer_1'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question2" id="question2" class="form-control " value="{{ (isset($arrQuestion['question_2']) && $arrQuestion['question_2']!='') ? $arrQuestion['question_2'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer2" id="answer2" class="form-control " value="{{ (isset($arrQuestion['answer_2']) && $arrQuestion['answer_2']!='') ? $arrQuestion['answer_2'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question3" id="question3" class="form-control " value="{{ (isset($arrQuestion['question_3']) && $arrQuestion['question_3']!='') ? $arrQuestion['question_3'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer3" id="answer3" class="form-control " value="{{ (isset($arrQuestion['answer_3']) && $arrQuestion['answer_3']!='') ? $arrQuestion['answer_3'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question4" id="question4" class="form-control " value="{{ (isset($arrQuestion['question_4']) && $arrQuestion['question_4']!='') ? $arrQuestion['question_4'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer4" id="answer4" class="form-control " value="{{ (isset($arrQuestion['answer_4']) && $arrQuestion['answer_4']!='') ? $arrQuestion['answer_4'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question5" id="question5" class="form-control " value="{{ (isset($arrQuestion['question_5']) && $arrQuestion['question_5']!='') ? $arrQuestion['question_5'] : '' }}" ><!-- classWord -->
                           ...
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer5" id="answer5" class="form-control " value="{{ (isset($arrQuestion['answer_5']) && $arrQuestion['answer_5']!='') ? $arrQuestion['answer_5'] : '' }}" ><!-- classWord -->
