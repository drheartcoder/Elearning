                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                              <div class="form-group m-b-10">
                                 ...
                                 <textarea name="question" id="question" class="form-control" rows="5" style="height: 100px" maxlength="200">{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}</textarea>
                           ...
                           <div class="col-sm-12">
                              <div class="form-group m-b-10">
                                 ...
                                 <input type="text" name="answer" id="answer" class="form-control" value="{{ (isset($arrQuestion['answer']) && $arrQuestion['answer']!='') ? $arrQuestion['answer'] : '' }}" >
