                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question" id="question" class="form-control " value="{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}" >
                                 <span class="error" id="err_question"> @if($errors->has('question')) {{ $errors->first('question') }} @endif </span>
                              </div>
                           </div>
                           <div class="col-sm-12">
                              <div class="form-group m-b-10">
                                 <label class="bmd-label-floating">Answer (Word)<span class="red">*</span></label>
                                 <input type="text" name="answer" id="answer" class="form-control classWord" value="{{ (isset($arrQuestion['answer']) && $arrQuestion['answer']!='') ? $arrQuestion['answer'] : '' }}" >
                                 <span class="error" id="err_answer"> @if($errors->has('direction')) {{ $errors->first('direction') }} @endif </span>
                              </div>
                              <span class="note-section-block form-note-section"><b>Note :</b> <span><span>Enter the words comma seperated.</span></span></span>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-sm-12">
