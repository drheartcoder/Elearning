                              ...
                              <div class="row wrapperDiv">
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="answer{{$i}}" id="answer{{$i}}" class="form-control answerCommon digitCommon" readonly="readonly" value="<?php if(isset($arrQuestion['answer'.$i])){ echo $arrQuestion['answer'.$i]; } ?>" >
