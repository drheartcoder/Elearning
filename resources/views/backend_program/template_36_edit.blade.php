                  ...
                  <form name="frmUpdate" id="frmUpdate" method="post" action="{{ $module_url_path.'/update' }}" enctype="multipart/form-data">
                     ...
                     <div class="devSubWrapper">
                        <div class="row">
                           ...
                           <div class="col-sm-4">
                              <label class="col-form-label">Question File 1 (Image) <span class="red">*</span></label>
                              <div style="position: relative;" class="form-group profile-img-block temp-img-block">
                                 <div class="pro-img">
                                    <?php
                                    ...
                                    <input style="height: 100%; width: 100%; z-index: 99;" id="flQuestion1" name="flQuestion1"  type="file" class="attachment_upload imgFile" />
                                 </div>
...
<!--                            <div class="col-sm-4">
                              <label class="col-form-label">Question File 2 (Image) </label>
                              <div style="position: relative;" class="form-group profile-img-block delete-img-section">
                                 <div class="pro-img">
                                    <?php
                                    ...
                                    <input style="height: 100%; width: 100%; z-index: 99;" id="flQuestion2" name="flQuestion2"  type="file" class="attachment_upload imgFile" />
                                 </div>
                                 <?php
                                    if(isset($arrQuestion['question_2_file']) && $arrQuestion['question_2_file']!='')
                                    {
                                      ...
                                      $urlQuestionImageDelete = url(config('app.project.creator_panel_slug')."/program/deleteQuestionFile/".base64_encode($programId).'/'.base64_encode($templateId).'/'.base64_encode($questionId).'/image/2/'.$arrQuestion['question_2_file']);
                                      ?>
                                 <a href="{{ $urlQuestionImageDelete }}" class="deleteQuestionFile" title="Delete" onclick="return confirm_action(this,event,'Do you really want to Delete a file ?')" ><i class="fa fa-trash-o"></i></a>
                                 <?php
                                    }
                                    }
                                    ?>
                                 <span class="error" id="err_flQuestion2"> @if($errors->has('flQuestion2')) {{ $errors->first('flQuestion2') }} @endif </span>
                                 <span class="note-section-block"><b>Note :</b> <span>Allowed only jpg | jpeg | png</span></span>
                              </div>
                              <?php
                                 ?>
                           </div> -->
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="answer" id="answer" class="form-control answerCommon digitCommon" value="<?php if(isset($arrQuestion['answer'])){ echo $arrQuestion['answer']; } ?>" >
...
<script type="text/javascript">
   /*$(document).on('click', '.deleteQuestionFile', function(){
     if(confirm)
     {
       alert('YES');
     }
