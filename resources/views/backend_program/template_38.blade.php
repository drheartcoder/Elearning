<div class="devSubWrapper">
   <div class="row">
      ...
      <div class="col-sm-4">
         <div class="form-group">
            ...
            <input type="text" name="answer1" id="answer1" class="form-control " value="{{ old('answer1') }}" maxlength="6">
      ...
      <div class="col-sm-4">
         <div class="form-group">
            ...
            <input type="text" name="answer2" id="answer2" class="form-control " value="{{ old('answer2') }}" maxlength="6">
      ...
      <div class="col-sm-4">
         <div class="form-group">
            ...
            <input type="text" name="answer3" id="answer3" class="form-control " value="{{ old('answer3') }}" maxlength="6">
      ...
      <div class="col-sm-4">
         <div class="form-group">
            ...
            <input type="text" name="answer4" id="answer4" class="form-control " value="{{ old('answer4') }}" maxlength="6">
   ...
   <div class="row">
      <div class="col-sm-6">
         ...
         <div class="form-group upload-block m-b-6">                                                
