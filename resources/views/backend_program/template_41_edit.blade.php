...
<script type="text/javascript">
   ...
   function validateForm(){
       ...
       var question2_1=CKEDITOR.instances['question2_1'].getData().replace(/<[^>]*>/gi, '').length;
       var question2_2=CKEDITOR.instances['question2_2'].getData().replace(/<[^>]*>/gi, '').length;
       var operator2 = $('#operator2').val();
   
       var question3_1=CKEDITOR.instances['question3_1'].getData().replace(/<[^>]*>/gi, '').length;
       var question3_2=CKEDITOR.instances['question3_2'].getData().replace(/<[^>]*>/gi, '').length;
       var operator3 = $('#operator3').val();
   
       var question4_1=CKEDITOR.instances['question4_1'].getData().replace(/<[^>]*>/gi, '').length;
       var question4_2=CKEDITOR.instances['question4_2'].getData().replace(/<[^>]*>/gi, '').length;
       var operator4 = $('#operator4').val();
   
       var question5_1=CKEDITOR.instances['question5_1'].getData().replace(/<[^>]*>/gi, '').length;
       var question5_2=CKEDITOR.instances['question5_2'].getData().replace(/<[^>]*>/gi, '').length;
       var operator5 = $('#operator5').val();
   
       var question6_1=CKEDITOR.instances['question6_1'].getData().replace(/<[^>]*>/gi, '').length;
       var question6_2=CKEDITOR.instances['question6_2'].getData().replace(/<[^>]*>/gi, '').length;
       var operator6 = $('#operator6').val();
       ...
       $('#err_question3_1').html('');
       $('#err_question3_2').html('');
       $('#err_operator3').html('');
   
       $('#err_question4_1').html('');
       $('#err_question4_2').html('');
       $('#err_operator4').html('');
   
       $('#err_question5_1').html('');
       $('#err_question5_2').html('');
       $('#err_operator5').html('');
   
       $('#err_question6_1').html('');
       $('#err_question6_2').html('');
       $('#err_operator6').html('');
