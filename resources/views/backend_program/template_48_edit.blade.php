                        ...
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="question" id="question" class="form-control classWord" value="{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}" maxlength="45" >
                           ...
                           <?php
                              $arrQuestionLetter = [];
                              if(isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='')
                              {
                                $arrQuestionLetter = str_split($arrQuestion['question_1']);
                              }
                              $arrAnswerPosition = [];
