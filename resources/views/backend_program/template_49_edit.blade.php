                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-8">
                              ...
                              <div class="form-group editor-section-block">
                                 <textarea class="form-control ckeditor" name="question" id="question" placeholder="Question">{{ (isset($arrQuestion['question_1']) && $arrQuestion['question_1']!='') ? $arrQuestion['question_1'] : '' }}</textarea> 
                           ...
                           <div class="col-sm-12">
                              <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group editor-section-block">
                                       <textarea class="form-control ckeditor" name="option_1" id="option_1" placeholder="Option 1">{{ (isset($arrQuestion['option_1']) && $arrQuestion['option_1']!='') ? $arrQuestion['option_1'] : '' }}</textarea> 
                                 ...
                                 <div class="col-sm-6">
                                    <div class="radio-btns">
                                       <div class="radio-btn radio-first-option">
                                          <input type="radio" id="rdoOption_1" name="rdoOption" value="1" @if(isset($arrQuestion['answer']) && $arrQuestion['answer']==1) checked @endif >
                           ...
                           <div class="col-sm-12">
                              <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group editor-section-block">
                                       <textarea class="form-control ckeditor" name="option_2" id="option_2" placeholder="Option 2">{{ (isset($arrQuestion['option_2']) && $arrQuestion['option_2']!='') ? $arrQuestion['option_2'] : '' }}</textarea> 
                                 ...
                                 <div class="col-sm-6">
                                    <div class="radio-btns">
                                       <div class="radio-btn radio-first-option">
                                          <input type="radio" id="rdoOption_2" name="rdoOption" value="2" @if(isset($arrQuestion['answer']) && $arrQuestion['answer']==2) checked @endif >
                           ...
                           <div class="col-sm-12">
                              <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group editor-section-block">
                                       <textarea class="form-control ckeditor" name="option_3" id="option_3" placeholder="Option 3">{{ (isset($arrQuestion['option_3']) && $arrQuestion['option_3']!='') ? $arrQuestion['option_3'] : '' }}</textarea> 
                                 ...
                                 <div class="col-sm-6">
                                    <div class="radio-btns">
                                       <div class="radio-btn radio-first-option">
                                          <input type="radio" id="rdoOption_3" name="rdoOption" value="3" @if(isset($arrQuestion['answer']) && $arrQuestion['answer']==3) checked @endif >
                           ...
                           <div class="col-sm-12">
                              <div class="row">
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group editor-section-block">
                                       <textarea class="form-control ckeditor" name="option_4" id="option_4" placeholder="Option 4">{{ (isset($arrQuestion['option_4']) && $arrQuestion['option_4']!='') ? $arrQuestion['option_4'] : '' }}</textarea> 
                                 ...
                                 <div class="col-sm-6">
                                    <div class="radio-btns">
                                       <div class="radio-btn radio-first-option">
                                          <input type="radio" id="rdoOption_4" name="rdoOption" value="4" @if(isset($arrQuestion['answer']) && $arrQuestion['answer']==4) checked @endif >
...
<script type="text/javascript"> 
   ...
   $('#btnSubmit').click(function(){
    ...
    if(flag==true)
    {
      ...
      var option_1 = CKEDITOR.instances['option_1'].getData();
      var option_2 = CKEDITOR.instances['option_2'].getData();
      var option_3 = CKEDITOR.instances['option_3'].getData();
      var option_4 = CKEDITOR.instances['option_4'].getData();
