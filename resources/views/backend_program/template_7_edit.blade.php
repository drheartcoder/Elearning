                           ...
                           <div class="col-sm-6">
                              ...
                              <div style="position: relative;" class="form-group">
                                 <div class="profile-img-block temp-img-block">
                                    ...
                                    <span class="note-section-block"><b>Note :</b> <span>Allowed only jpg | jpeg | png, <br/> Upload image greater than or equal to 210 X 210 for best result.</span></span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-sm-6">
...
<script type="text/javascript">
  ...
  $('.imgFile').change(function(){
       ...
       imageSizeValidate(tempThis, files, '210', '210');
   });
