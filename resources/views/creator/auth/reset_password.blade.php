			...
			<div class="page-header login-page header-filter">
				<div class="container">
					<div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
						<form action="{{url('/')}}/program-creator/forgot_password/postReset" method="post" id="frm_forgot" class="form form-validate">
						{{csrf_field()}}
							...
							<div class="card card-login card-hidden">
								...
								<div class="card-body">
									<span class="bmd-form-group">
										<div class="input-group">
											...
											<input type="password" name="password" id="password" class="form-control" placeholder="Your New Password" data-rule-required="true" required="required" minlength="6" data-rule-maxlength="16">
										</div>
									</span>
									<span class="bmd-form-group">
										<div class="input-group">
											...
											<input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Confirm Password" data-rule-required="true" required="required" minlength="6" data-rule-maxlength="16">
										</div>
									</span>
								</div>
								...
								<div class="back-to-login">
                                    <a href="{{url('/')}}/program-creator" class="btn btn-rose btn-link btn-lg">Back To Login</a>
                                </div>
							</div>
						</form>
					</div>
