...
<html lang="en">
   ...
   <head>
      ...
      <script type="text/javascript">
         var SITE_URL       = "{{url('/')}}";
         var SITE_ADMIN_URL = "{{url('/')}}/"+"{{config('app.project.creator_panel_slug')}}";
         var csrf_token     = "{{ csrf_token() }}";
      </script>
   </head>
   @php
      $creator_path = config('app.project.creator_panel_slug');
   @endphp
   <body class="">
      <!-- Extra details for Live View on GitHub Pages -->      
      <div class="wrapper ">
         <div class="sidebar" data-color="rose" data-background-color="black" data-image="{{url('/')}}/assets/img/sidebar-1.jpg">
            ...
            @include('creator.layout._sidebar')
         </div>
                  ...
                  <div class="collapse navbar-collapse justify-content-end">
                     ...
                     <ul class="navbar-nav">                      
                        <li class="nav-item dropdown">
                           <a class="nav-link" href="{{url('/').'/'.$creator_path.'/notifications'}}">
                        ...
                        <li class="nav-item">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                              <a class="dropdown-item" href="{{url('/').'/'.$creator_path.'/account_setting'}}">Edit Profile</a>
                              <a class="dropdown-item" href="{{url('/').'/'.$creator_path.'/account_setting/password/change'}}">Change Password</a>
                              <a class="dropdown-item" href="{{ url('/').'/'.$creator_path }}/logout">Logout</a>
                           </div>
                        </li>
                     </ul>
                  </div>
