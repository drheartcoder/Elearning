        ...
        <div class="col-sm-8 col-md-9 col-lg-9">   
            <div class="my-profile-section">
                <div class="row">
                    ...
                    <form id="form_parent_change_password" method="POST" action="{{ url('/') }}/parent/account-setting/password/update">
                        {{ csrf_field() }}
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-button-section">
                                <button type="submit" id="btn_parent_change_password" class="full-fill-button sim-button">{{trans('parent.Save')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
