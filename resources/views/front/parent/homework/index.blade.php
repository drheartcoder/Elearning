                                    ...
                                    <div class="file-block">
                                        <div class="file-img">{!! $file_html !!}</div>
                                          @if($subscription_plan_status==true)
                                               <a class="full-fill-button border-button sim-button-blue" onclick="ShowSubscriptionExpiredMsg()"  >{{trans('parent.Download')}}</a> 
                                        @elseif($plan_purchased_status==false)
                                                <a class="full-fill-button border-button sim-button-blue" onclick="ShowSubscriptionErrorMsg()"  >{{trans('parent.Download')}}</a> 
                                        @else
    ...
    $(document).ready(function(){
        ...
        function getEncHomeworkGrade(subject_id = false, grade_id = false) {
            $.ajax({
                ...
                type : "POST",
                data : { _token:csrf_token, subject_id:subject_id, grade_id:grade_id, user:"parent" },
        ...
        function getEncHomeworkProgram(subject_id = false, grade_id = false, program_id = false) {
            $.ajax({
                ...
                type : "POST",
                data : { _token:csrf_token, subject_id:subject_id, grade_id:grade_id, program_id:program_id, user:"parent" },
                success : function(result) {
        ...
        function getEncHomeworkLesson(subject_id = false, grade_id = false, program_id = false, lesson_id = false) {
            $.ajax({
                ...
                type : "POST",
                data : { _token:csrf_token, subject_id:subject_id, grade_id:grade_id, program_id:program_id, lesson_id:lesson_id, user:"parent" },
                success : function(result) {
