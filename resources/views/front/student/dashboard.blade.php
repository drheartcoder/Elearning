@include('front.layout.bredcrum')
                        ...
                        <div class="student-info">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <!-- <p><b>Student Name :</b> Emma Thomas</p>
                                    <p><b>Class :</b> A</p> -->
                        ...
                        <div class="students-grade-section">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    ...
                                    <div class="grade-ring {{ $class }}">{{ $arr_data['arr_student_data']['student_total_points'] or ''}}<span>Points</span></div>
    ...
    function getSelectedType(type)
    {
        var type = $('#type').val();
        var selected_year = $('#selected_year').val();
        location.href= '{{ $module_url_path }}/'+type+'/'+selected_year;
