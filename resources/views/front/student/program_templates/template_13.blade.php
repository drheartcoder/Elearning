...
@php
    $uniqid = uniqid();
    $str_options = $arr_question['template13']['answer1'].','.$arr_question['template13']['answer3'].','.$arr_question['template13']['answer2'].','.$arr_question['template13']['answer4'].','.$arr_question['template13']['answer6'].','.$arr_question['template13']['answer5'];
    $arr_options = options_array_shuffle($str_options);
@endphp
    <!--middle section-->
    <div class="middle-section temp-13-main-section">
        <div class="container">
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template13']['question']) && $arr_question['template13']['question']!='' ? ucwords($arr_question['template13']['question']) : "N/A" }}
                    </div>
                ...
                <div class="row drawLineSection">
                    <div class="col-sm-2 col-mg-2 col-lg-2">                                                
                        <div class="game-img-section temp-4-letter-section-div">
                            ...
                            @endif
                            @if(isset($arr_question['template13']['question_1_file']) && $arr_question['template13']['question_1_file']!='')
                                @php $result = get_image_public_path($arr_question['template13']['question_1_file'],'image');  @endphp
                                @if($arr_question['is_answer']=="no")
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_1" data-answer="{{isset($arr_question['template13']['answer1']) && $arr_question['template13']['answer1']!='' ? $arr_question['template13']['answer1'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                                @else
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_1" data-answer="{{isset($arr_question['template13']['answer1']) && $arr_question['template13']['answer1']!='' ? $arr_question['template13']['answer1'] : 'N/A' }}" class="checkQuestion"/>
                                @endif
                            @endif
                        </div>
                        @if($arr_question['is_answer']=="no")
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                        @if(isset($arr_question['template13']['question_2_file']) && $arr_question['template13']['question_2_file']!='')
                           @php $result = get_image_public_path($arr_question['template13']['question_2_file'],'image');  @endphp
                           @if($arr_question['is_answer']=="no")
                                <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_2" data-answer="{{isset($arr_question['template13']['answer2']) && $arr_question['template13']['answer2']!='' ? $arr_question['template13']['answer2'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                            @else
                                <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_2" data-answer="{{isset($arr_question['template13']['answer2']) && $arr_question['template13']['answer2']!='' ? $arr_question['template13']['answer2'] : 'N/A' }}" class="checkQuestion"/>
                            @endif                            
                        @endif                            
                        </div>
                        @if($arr_question['is_answer']=="no")
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['template13']['question_3_file']) && $arr_question['template13']['question_3_file']!='')
                                @php $result = get_image_public_path($arr_question['template13']['question_3_file'],'image');  @endphp
                                @if($arr_question['is_answer']=="no")
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_3" data-answer="{{isset($arr_question['template13']['answer3']) && $arr_question['template13']['answer3']!='' ? $arr_question['template13']['answer3'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                                @else
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_3" data-answer="{{isset($arr_question['template13']['answer3']) && $arr_question['template13']['answer3']!='' ? $arr_question['template13']['answer3'] : 'N/A' }}" class="checkQuestion"/>
                                @endif
                            @endif
                        </div>
                        @if($arr_question['is_answer']=="no")
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['template13']['question_4_file']) && $arr_question['template13']['question_4_file']!='')
                                @php $result = get_image_public_path($arr_question['template13']['question_4_file'],'image');  @endphp
                                @if($arr_question['is_answer']=="no")
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_4" data-answer="{{isset($arr_question['template13']['answer4']) && $arr_question['template13']['answer4']!='' ? $arr_question['template13']['answer4'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                                @else
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_4" data-answer="{{isset($arr_question['template13']['answer4']) && $arr_question['template13']['answer4']!='' ? $arr_question['template13']['answer4'] : 'N/A' }}" class="checkQuestion"/>
                                @endif
                            @endif
                        </div>
                        @if($arr_question['is_answer']=="no")
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['template13']['question_5_file']) && $arr_question['template13']['question_5_file']!='')
                                @php $result = get_image_public_path($arr_question['template13']['question_5_file'],'image');  @endphp
                                @if($arr_question['is_answer']=="no")
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_5" data-answer="{{isset($arr_question['template13']['answer5']) && $arr_question['template13']['answer5']!='' ? $arr_question['template13']['answer5'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                                @else
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_5" data-answer="{{isset($arr_question['template13']['answer5']) && $arr_question['template13']['answer5']!='' ? $arr_question['template13']['answer5'] : 'N/A' }}" class="checkQuestion"/>
                                @endif
                            @endif
                        </div>
                        @if($arr_question['is_answer']=="no")
                            <div class="img-name-txt-section checkAnswer" id="answer_5" data-answer="{{isset($arr_options[4]) && $arr_options[4]!='' ? $arr_options[4] : 'N/A' }}" style="cursor: pointer;" onclick="checkAnswer(this)">{{isset($arr_options[4]) && $arr_options[4]!='' ? ucwords($arr_options[4]) : "N/A" }}</div>
                        @else
                            <div class="img-name-txt-section checkAnswer" id="answer_5" data-answer="{{isset($arr_options[4]) && $arr_options[4]!='' ? $arr_options[4] : 'N/A' }}">{{isset($arr_options[4]) && $arr_options[4]!='' ? ucwords($arr_options[4]) : "N/A" }}</div>
                        @endif
                    </div>
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                            @if(isset($arr_question['template13']['question_6_file']) && $arr_question['template13']['question_6_file']!='')
                               @php $result = get_image_public_path($arr_question['template13']['question_6_file'],'image');  @endphp
                               @if($arr_question['is_answer']=="no")
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_6" data-answer="{{isset($arr_question['template13']['answer6']) && $arr_question['template13']['answer6']!='' ? $arr_question['template13']['answer6'] : 'N/A' }}" style="cursor: pointer;" class="checkQuestion" onclick="checkQuestion(this)"/>
                                @else
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_6" data-answer="{{isset($arr_question['template13']['answer6']) && $arr_question['template13']['answer6']!='' ? $arr_question['template13']['answer6'] : 'N/A' }}" class="checkQuestion"/>
                                @endif                            
                            @endif
                        ...
                        @if($arr_question['is_answer']=="no")
                            <div class="img-name-txt-section checkAnswer" id="answer_6" data-answer="{{isset($arr_options[5]) && $arr_options[5]!='' ? $arr_options[5] : 'N/A' }}" style="cursor: pointer;" onclick="checkAnswer(this)">{{isset($arr_options[5]) && $arr_options[5]!='' ? ucwords($arr_options[5]) : "N/A" }}</div>
                        @else
                            <div class="img-name-txt-section checkAnswer" id="answer_6" data-answer="{{isset($arr_options[5]) && $arr_options[5]!='' ? $arr_options[5] : 'N/A' }}">{{isset($arr_options[5]) && $arr_options[5]!='' ? ucwords($arr_options[5]) : "N/A" }}</div>
                        @endif
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template13']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template13']['duration']));
            $minutes     = date('i',strtotime($arr_question['template13']['duration']));
            $seconds     = date('s',strtotime($arr_question['template13']['duration']));
        }
        $actual_time = $arr_question['template13']['duration'];
