...
@php
    $uniqid = uniqid();
    $str_options = $arr_question['template14']['answer1'].','.$arr_question['template14']['answer2'].','.$arr_question['template14']['answer3'].','.$arr_question['template14']['answer4'].','.$arr_question['template14']['answer5'].','.$arr_question['template14']['answer6'];
    $arr_options = options_array_shuffle($str_options);
    $maxlength   = 0;
@endphp
    <!--middle section-->
    <div class="middle-section temp-14-main-section">
        <div class="container">
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template14']['question']) && $arr_question['template14']['question']!='' ? ucwords($arr_question['template14']['question'])." : " : "N/A" }} <br>
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        ...
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_1_file']) && $arr_question['template14']['question_1_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_1_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer1']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer1']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                        
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_2_file']) && $arr_question['template14']['question_2_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_2_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer2']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer2']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                 
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_3_file']) && $arr_question['template14']['question_3_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_3_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer3']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer3']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                        
                                    </div>
                                </div>
                            </div>                                                            
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_4_file']) && $arr_question['template14']['question_4_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_4_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer4']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer4']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                        
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_5_file']) && $arr_question['template14']['question_5_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_5_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer5']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer5']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                       
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template14']['question_6_file']) && $arr_question['template14']['question_6_file']!='')
                                            @php $result = get_image_public_path($arr_question['template14']['question_6_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 11" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" value="{{$arr_question['template14']['answer6']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template14']['answer6']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif                                        
                                    </div>
                                </div>
                            </div>                                                                                     
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template14']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template14']['duration']));
            $minutes     = date('i',strtotime($arr_question['template14']['duration']));
            $seconds     = date('s',strtotime($arr_question['template14']['duration']));
        }
        $actual_time = $arr_question['template14']['duration'];
