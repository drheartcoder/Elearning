...
@php
    $uniqid = uniqid();
    $str_options = $arr_question['template19']['question_1_answer'].','.$arr_question['template19']['question_2_answer'].','.$arr_question['template19']['question_3_answer'].','.$arr_question['template19']['question_4_answer'].','.$arr_question['template19']['question_5_answer'].','.$arr_question['template19']['question_6_answer'];
...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template19']['question']) && $arr_question['template19']['question']!='' ? ucwords($arr_question['template19']['question'])." : " : "N/A" }} <br>
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        ...
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_1_file']) && $arr_question['template19']['question_1_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_1_file'],'image');  @endphp
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_1_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_1_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div> 
                            <div class="display-table-section middle-img-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_2_file']) && $arr_question['template19']['question_2_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_2_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 19" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_2_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_2_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_3_file']) && $arr_question['template19']['question_3_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_3_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 19" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_3_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_3_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div>                                                            
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_4_file']) && $arr_question['template19']['question_4_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_4_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 19" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_4_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_4_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_5_file']) && $arr_question['template19']['question_5_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_5_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 19" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_5_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_5_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-img-section">
                                        @if(isset($arr_question['template19']['question_6_file']) && $arr_question['template19']['question_6_file']!='')
                                            @php $result = get_image_public_path($arr_question['template19']['question_6_file'],'image');  @endphp
                                            <img src="{{$result['image_url']}}" alt="tamplate 19" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-19-ans-section">                                        
                                        @if($arr_question['is_answer']=='yes')
                                            <input class="correct-ans uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" value="{{$arr_question['template19']['question_6_answer']}}" disabled="true" />
                                        @else
                                            <input class="actual-ans questionCls uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" data-answer="{{$arr_question['template19']['question_6_answer']}}" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />
                                        @endif
                                    </div>
                                </div>
                            </div>                                                                                     
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template19']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template19']['duration']));
            $minutes     = date('i',strtotime($arr_question['template19']['duration']));
            $seconds     = date('s',strtotime($arr_question['template19']['duration']));
        }
        $actual_time = $arr_question['template19']['duration'];
