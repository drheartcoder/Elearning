...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template25']['question']) && $arr_question['template25']['question']!='' ? ucwords($arr_question['template25']['question'])." : " : "N/A" }} <br>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="game-img-section">
                            @php $result = get_image_public_path($arr_question['template25']['question_1_file'],'video');  @endphp
                        ...
                        <div class="game-fill-text-section">
                            <div class="fill-txt-section">
                                <div class="paragraph-section">
                                    {!! isset($arr_question['template25']['question_1']) && $arr_question['template25']['question_1']!='' ? $arr_question['template25']['question_1'] : "N/A" !!} 
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template25']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template25']['duration']));
            $minutes     = date('i',strtotime($arr_question['template25']['duration']));
            $seconds     = date('s',strtotime($arr_question['template25']['duration']));
        }
        $actual_time = $arr_question['template25']['duration'];
