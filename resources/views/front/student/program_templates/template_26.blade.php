...
<div class="middle-section temp-26-main-section">
        ...
        <div class="fill-in-the-blank-section template-26-main">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template26']['question']) && $arr_question['template26']['question']!='' ? ucwords($arr_question['template26']['question']) : "N/A" }}
                    </div>
                        ...
                        <div class="game-img-section">                            
                            <div class="question-section-txt">                                
                                <div class="temp-26-question-section">
                                    <span class="ques-text-section">1. {{isset($arr_question['template26']['question_1_text']) && $arr_question['template26']['question_1_text']!='' ? ucwords($arr_question['template26']['question_1_text']) : "N/A" }}</span>
                                    <div class="radio-btns">  
                                        @if($arr_question['is_answer']=='no')
                                            <div class="radio-btn question1 @if($arr_question['template26']['question_1_answer']==1 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                                <input type="radio" id="f-option1" onclick="checkFinalAnswer(this)" value="1" name="question1">
                                                <label for="f-option1">{{ucwords($arr_question['template26']['question_1_option1'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @else
                                            <div class="radio-btn question1">
                                                <input type="radio" id="f-option1" @if($arr_question['template26']['question_1_answer']==1) checked="true" @endif value="1" name="question1" disabled="true">
                                                <label for="f-option1">{{ucwords($arr_question['template26']['question_1_option1'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                        <div class="radio-btn question1 @if($arr_question['template26']['question_1_answer']==2 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                            <input type="radio" id="s-option1" onclick="checkFinalAnswer(this)" value="2" name="question1">
                                            <label for="s-option1">{{ucwords($arr_question['template26']['question_1_option2'])}}</label>
                                            <div class="circle-block"></div>
                                        </div>
                                        @else
                                            <div class="radio-btn question1">
                                                <input type="radio" id="s-option1" @if($arr_question['template26']['question_1_answer']==2) checked="true" @endif value="2" name="question1" disabled="true">
                                                <label for="s-option1">{{ucwords($arr_question['template26']['question_1_option2'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                        <div class="radio-btn question1 @if($arr_question['template26']['question_1_answer']==3 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                            <input type="radio" id="t-option1" onclick="checkFinalAnswer(this)" value="3" name="question1">
                                            <label for="t-option1">{{ucwords($arr_question['template26']['question_1_option3'])}}</label>
                                            <div class="circle-block"></div>
                                        </div>
                                        @else
                                            <div class="radio-btn question1">
                                                <input type="radio" id="t-option1" @if($arr_question['template26']['question_1_answer']==3) checked="true" @endif value="3" name="question1" disabled="true">
                                                <label for="t-option1">{{ucwords($arr_question['template26']['question_1_option3'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                ...
                                <div class="temp-26-question-section">
                                    <span class="ques-text-section">2. {{isset($arr_question['template26']['question_2_text']) && $arr_question['template26']['question_2_text']!='' ? ucwords($arr_question['template26']['question_2_text']) : "N/A" }}</span>
                                    <div class="radio-btns">  
                                        @if($arr_question['is_answer']=='no')
                                        <div class="radio-btn question2 @if($arr_question['template26']['question_2_answer']==1 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                            <input type="radio" id="f-option2" onclick="checkFinalAnswer(this)" value="1" name="question2">
                                            <label for="f-option2">{{ucwords($arr_question['template26']['question_2_option1'])}}</label>
                                            <div class="circle-block"></div>
                                        </div>
                                        @else
                                            <div class="radio-btn question2">
                                                <input type="radio" id="f-option2" @if($arr_question['template26']['question_2_answer']==1) checked @endif value="1" name="question2" disabled="true">
                                                <label for="f-option2">{{ucwords($arr_question['template26']['question_2_option1'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                            <div class="radio-btn question2 @if($arr_question['template26']['question_2_answer']==2 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                                <input type="radio" id="s-option2" onclick="checkFinalAnswer(this)" value="2" name="question2">
                                                <label for="s-option2">{{ucwords($arr_question['template26']['question_2_option2'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @else
                                            <div class="radio-btn question2">
                                                <input type="radio" id="s-option2" @if($arr_question['template26']['question_2_answer']==2) checked @endif value="2" name="question2" disabled="true">
                                                <label for="s-option2">{{ucwords($arr_question['template26']['question_2_option2'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                            <div class="radio-btn question2 @if($arr_question['template26']['question_2_answer']==3 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                                <input type="radio" id="t-option2" onclick="checkFinalAnswer(this)" value="3" name="question2">
                                                <label for="t-option2">{{ucwords($arr_question['template26']['question_2_option3'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @else
                                            <div class="radio-btn question2">
                                                <input type="radio" id="t-option2" @if($arr_question['template26']['question_2_answer']==3) checked @endif value="3" name="question1" disabled="true">
                                                <label for="t-option2">{{ucwords($arr_question['template26']['question_2_option3'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                ...
                                <div class="temp-26-question-section">
                                    <span class="ques-text-section">3. {{isset($arr_question['template26']['question_3_text']) && $arr_question['template26']['question_3_text']!='' ? ucwords($arr_question['template26']['question_3_text']) : "N/A" }}</span>
                                    <div class="radio-btns">  
                                        @if($arr_question['is_answer']=='no')
                                        <div class="radio-btn question3 @if($arr_question['template26']['question_3_answer']==1 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                            <input type="radio" id="f-option3" onclick="checkFinalAnswer(this)" value="1" name="question3">
                                            <label for="f-option3">{{ucwords($arr_question['template26']['question_3_option1'])}}</label>
                                            <div class="circle-block"></div>
                                        </div>
                                        @else
                                            <div class="radio-btn question3">
                                                <input type="radio" id="f-option3" @if($arr_question['template26']['question_3_answer']==1) checked @endif value="1" name="question3" disabled="true">
                                                <label for="f-option3">{{ucwords($arr_question['template26']['question_3_option1'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                            <div class="radio-btn question3 @if($arr_question['template26']['question_3_answer']==2 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                                <input type="radio" id="s-option3" onclick="checkFinalAnswer(this)" value="2" name="question3">
                                                <label for="s-option3">{{ucwords($arr_question['template26']['question_3_option2'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @else
                                            <div class="radio-btn question3">
                                                <input type="radio" id="s-option3" @if($arr_question['template26']['question_3_answer']==2) checked @endif value="2" name="question3" disabled="true">
                                                <label for="s-option3">{{ucwords($arr_question['template26']['question_3_option2'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                                        @if($arr_question['is_answer']=='no')
                                            <div class="radio-btn question3 @if($arr_question['template26']['question_3_answer']==3 && $arr_question['is_delay']=='yes') time-over-answer-section  @endif">
                                                <input type="radio" id="t-option3" onclick="checkFinalAnswer(this)" value="3" name="question3">
                                                <label for="t-option3">{{ucwords($arr_question['template26']['question_3_option3'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @else
                                            <div class="radio-btn question3">
                                                <input type="radio" id="t-option3" @if($arr_question['template26']['question_3_answer']==3) checked @endif value="3" name="question3" disabled="true">
                                                <label for="t-option3">{{ucwords($arr_question['template26']['question_3_option3'])}}</label>
                                                <div class="circle-block"></div>
                                            </div>
                                        @endif
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template26']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template26']['duration']));
            $minutes     = date('i',strtotime($arr_question['template26']['duration']));
            $seconds     = date('s',strtotime($arr_question['template26']['duration']));
        }
        $actual_time = $arr_question['template26']['duration'];
...
<script type="text/javascript">
    ...
    var correct_answer1               = "{{$arr_question['template26']['question_1_answer']}}";
    var correct_answer2               = "{{$arr_question['template26']['question_2_answer']}}";
    var correct_answer3               = "{{$arr_question['template26']['question_3_answer']}}";
</script>
...
<script type="text/javascript">
    ...
    function checkFinalAnswer(ref)
    {
        ...
        var isQuestion3        = $(ref).parent().hasClass('question3');
        ...
        if((answer1!='' && answer1!=undefined) && (answer2!='' && answer2!=undefined) && (answer3!='' && answer3!=undefined)){
            if(answer1==correct_answer1 && answer2 == correct_answer2 && answer3 == correct_answer3)
            {
                $('input[type="radio"]').attr('disabled', true);
                $('.question1').removeClass('wrong-answer');
                $('.question2').removeClass('wrong-answer');
                $('.question3').removeClass('wrong-answer');
        ...
        if((answer3!='' && answer3!=undefined) && isQuestion3==true){
    ...
    if(is_answer=='no' && is_delay=='yes')
    {
        ...
        $('input[name="question3"]').each(function(){
            if($(this).val()==correct_answer3 && is_answer=="no")
            {
                $(this).closest( "div" ).addClass('time-over-answer-section');   
            }
        });
