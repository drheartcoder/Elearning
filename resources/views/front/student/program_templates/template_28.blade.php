...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template28']['question']) && $arr_question['template28']['question']!='' ? ucwords($arr_question['template28']['question'])." : " : "N/A" }} <br>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-mg-12 col-lg-12">
                        ...
                        <div class="game-img-section">                            
                            @if(isset($arr_question['template28']['question_1']) && $arr_question['template28']['question_1']!='')
                                <div class="question-section-txt">
                                    @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans uppercase-style" type="text" style="text-align: center;" value="{{$arr_question['template28']['answer_1']}}" disabled="true" data-answer="{{$arr_question['template28']['answer_1']}}" name="question1" maxlength="1">{{$arr_question['template28']['question_1']}}
                                    @else
                                        <input class="actual-ans questionCls uppercase-style" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template28']['answer_1']}}" type="text" name="question1" maxlength="1" />{{$arr_question['template28']['question_1']}}
                                    @endif
                                </div>
                            @endif
                            @if(isset($arr_question['template28']['question_2']) && $arr_question['template28']['question_2']!='')
                                <div class="question-section-txt">
                                    @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans uppercase-style" type="text" style="text-align: center;" value="{{$arr_question['template28']['answer_2']}}" disabled="true" data-answer="{{$arr_question['template28']['answer_2']}}" name="question2" maxlength="1">{{$arr_question['template28']['question_2']}}
                                    @else
                                        <input class="actual-ans questionCls uppercase-style" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template28']['answer_2']}}" type="text" name="question2" maxlength="1" />{{$arr_question['template28']['question_2']}}
                                    @endif
                                </div>
                            @endif
                            @if(isset($arr_question['template28']['question_3']) && $arr_question['template28']['question_3']!='')
                                <div class="question-section-txt">
                                    @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans uppercase-style" type="text" style="text-align: center;" value="{{$arr_question['template28']['answer_3']}}" disabled="true" data-answer="{{$arr_question['template28']['answer_3']}}" name="question3" maxlength="1">{{$arr_question['template28']['question_3']}}
                                    @else
                                        <input class="actual-ans questionCls uppercase-style" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template28']['answer_3']}}" type="text" name="question3" maxlength="1" />{{$arr_question['template28']['question_3']}}
                                    @endif
                                </div>
                            @endif
                            @if(isset($arr_question['template28']['question_4']) && $arr_question['template28']['question_4']!='')
                                <div class="question-section-txt">
                                    @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans uppercase-style" type="text" style="text-align: center;" value="{{$arr_question['template28']['answer_4']}}" disabled="true" data-answer="{{$arr_question['template28']['answer_4']}}" name="question4" maxlength="1">{{$arr_question['template28']['question_4']}}
                                    @else
                                        <input class="actual-ans questionCls uppercase-style" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template28']['answer_4']}}" type="text" name="question4" maxlength="1" />{{$arr_question['template28']['question_4']}}
                                    @endif
                                </div>
                            @endif
                            @if(isset($arr_question['template28']['question_5']) && $arr_question['template28']['question_5']!='')
                                <div class="question-section-txt">
                                    @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans uppercase-style" type="text" style="text-align: center;" value="{{$arr_question['template28']['answer_5']}}" disabled="true" data-answer="{{$arr_question['template28']['answer_5']}}" name="question4" maxlength="1">{{$arr_question['template28']['question_5']}}
                                    @else
                                        <input class="actual-ans questionCls uppercase-style" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template28']['answer_5']}}" type="text" name="question4" maxlength="1" />{{$arr_question['template28']['question_5']}}
                                    @endif
                                </div>
                            @endif
                        </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template28']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template28']['duration']));
            $minutes     = date('i',strtotime($arr_question['template28']['duration']));
            $seconds     = date('s',strtotime($arr_question['template28']['duration']));
        }
        $actual_time = $arr_question['template28']['duration'];
