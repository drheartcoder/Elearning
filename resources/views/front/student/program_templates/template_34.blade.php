...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template34']['question']) && $arr_question['template34']['question']!='' ? ucwords($arr_question['template34']['question'])." : " : "N/A" }} <br>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        ...
                        <div class="game-img-section">
                            @if(isset($arr_question['template34']['question_file']) && $arr_question['template34']['question_file']!='')
                                @php $result = get_image_public_path($arr_question['template34']['question_file'],'image');  @endphp
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        <div class="game-fill-text-section">
                            <div class="fill-txt-section img-calculations">
                                <ul>
                                  <li>{{isset($arr_question['template34']['digit1_1']) && $arr_question['template34']['digit1_1']!='' ? $arr_question['template34']['digit1_1'] : 0 }}</li>
                                  <li>
                                    @if($arr_question['template34']['operator1'] && $arr_question['template34']['operator1']!='')
                                        @if($arr_question['template34']['operator1'] != '/')
                                          {{$arr_question['template34']['operator1']}}
                                        @else
                                          &#247;
                                        @endif
                                    @endif
                                  </li>
                                  <li>{{isset($arr_question['template34']['digit1_2']) && $arr_question['template34']['digit1_2']!='' ? $arr_question['template34']['digit1_2'] : 0 }}</li>
                                  <li>=</li>
                                  <li>
                                      @if($arr_question['is_answer']=='yes')
                                        <input class="correct-ans" type="text" style="text-align: center;" value="{{$arr_question['template34']['answer1']}}" disabled="true" data-answer="{{$arr_question['template34']['answer1']}}" name="question1" maxlength="{{strlen($arr_question['template34']['answer1'])}}">
                                     @else
                                        <input class="actual-ans questionCls" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template34']['answer1']}}" type="text" name="question1" maxlength="{{strlen($arr_question['template34']['answer1'])}}" />
                                     @endif
                                 </li>
                               </ul>
                            </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section" style="display: none">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template34']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template34']['duration']));
            $minutes     = date('i',strtotime($arr_question['template34']['duration']));
            $seconds     = date('s',strtotime($arr_question['template34']['duration']));
        }
        $actual_time = $arr_question['template34']['duration'];
