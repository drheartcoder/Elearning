...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template38']['question']) && $arr_question['template38']['question']!='' ? ucwords($arr_question['template38']['question'])." : " : "N/A" }} <br>
                    </div>
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        ...
                        <div class="game-img-section">
                           <div class="temp-36-img">
                               @if(isset($arr_question['template38']['question_file']) && $arr_question['template38']['question_file']!='')
                                @php $result = get_image_public_path($arr_question['template38']['question_file'],'image');  @endphp
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        <div class="game-fill-text-section">
                            <div class="fill-txt-section">
                              @if(isset($arr_question['template38']['question_1']) && $arr_question['template38']['question_1']!='')
                                 <div class="temp-38-textblock-w">
                                     <div class="temp-38-textblock">
                                         <p>{{ucfirst($arr_question['template38']['question_1'])}}</p>
                                         @if($arr_question['is_answer']=='yes')
                                            <input class="input-number correct-ans" type="text" style="text-align: center;" value="{{$arr_question['template38']['answer_1']}}" disabled="true" data-answer="{{$arr_question['template38']['answer_1']}}" name="question1" maxlength="{{strlen($arr_question['template38']['answer_1'])}}">
                                          @else
                                            <input class="input-number actual-ans questionCls" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template38']['answer_1']}}" type="text" name="question1" maxlength="{{strlen($arr_question['template38']['answer_1'])}}" />
                                          @endif
                                     </div>
                                 </div>
                               @endif
                               @if(isset($arr_question['template38']['question_2']) && $arr_question['template38']['question_2']!='')
                                 <div class="temp-38-textblock-w">
                                     <div class="temp-38-textblock">
                                         <p>{{ucfirst($arr_question['template38']['question_2'])}}</p>
                                         @if($arr_question['is_answer']=='yes')
                                            <input class="input-number correct-ans" type="text" style="text-align: center;" value="{{$arr_question['template38']['answer_2']}}" disabled="true" data-answer="{{$arr_question['template38']['answer_2']}}" name="question2" maxlength="{{strlen($arr_question['template38']['answer_2'])}}">
                                          @else
                                            <input class="input-number actual-ans questionCls" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template38']['answer_2']}}" type="text" name="question2" maxlength="{{strlen($arr_question['template38']['answer_2'])}}" />
                                          @endif
                                     </div>
                                 </div>
                               @endif
                               @if(isset($arr_question['template38']['question_3']) && $arr_question['template38']['question_3']!='')
                                 <div class="temp-38-textblock-w">
                                     <div class="temp-38-textblock">
                                         <p>{{ucfirst($arr_question['template38']['question_3'])}}</p>
                                         @if($arr_question['is_answer']=='yes')
                                            <input class="input-number correct-ans" type="text" style="text-align: center;" value="{{$arr_question['template38']['answer_3']}}" disabled="true" data-answer="{{$arr_question['template38']['answer_3']}}" name="question3" maxlength="{{strlen($arr_question['template38']['answer_3'])}}">
                                          @else
                                            <input class="input-number actual-ans questionCls" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template38']['answer_3']}}" type="text" name="question3" maxlength="{{strlen($arr_question['template38']['answer_3'])}}" />
                                          @endif
                                     </div>
                                 </div>
                               @endif
                               @if(isset($arr_question['template38']['question_4']) && $arr_question['template38']['question_4']!='')
                                 <div class="temp-38-textblock-w">
                                     <div class="temp-38-textblock">
                                         <p>{{ucfirst($arr_question['template38']['question_4'])}}</p>
                                         @if($arr_question['is_answer']=='yes')
                                            <input class="input-number correct-ans" type="text" style="text-align: center;" value="{{$arr_question['template38']['answer_4']}}" disabled="true" data-answer="{{$arr_question['template38']['answer_4']}}" name="question4" maxlength="{{strlen($arr_question['template38']['answer_4'])}}">
                                          @else
                                            <input class="input-number actual-ans questionCls" style="text-align: center;" onkeyup="checkAnswer(this,event)" value="" data-answer="{{$arr_question['template38']['answer_4']}}" type="text" name="question4" maxlength="{{strlen($arr_question['template38']['answer_4'])}}" />
                                          @endif
                                     </div>
                                 </div>
                               @endif
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section" style="display: none">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template38']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template38']['duration']));
            $minutes     = date('i',strtotime($arr_question['template38']['duration']));
            $seconds     = date('s',strtotime($arr_question['template38']['duration']));
        }
        $actual_time = $arr_question['template38']['duration'];
