...
@php
    ...
    if(isset($arr_question['template45']['question1_1']) && $arr_question['template45']['question1_1']!=''){
      $str_options1 = $arr_question['template45']['answer1_1'];
      $arr_options1 = explode(',',$str_options1);
      $question1    = $arr_question['template45']['question1_1'];
    }
    if(isset($arr_question['template45']['question1_2']) && $arr_question['template45']['question1_2']!=''){
      $str_options2 = $arr_question['template45']['answer1_2'];
      $arr_options2 = explode(',',$str_options2);
      $question2    = $arr_question['template45']['question1_2'];
    }
    if(isset($arr_question['template45']['question1_3']) && $arr_question['template45']['question1_3']!=''){
      $str_options3 = $arr_question['template45']['answer1_3'];
      $arr_options3 = explode(',',$str_options3);
      $question3    = $arr_question['template45']['question1_3'];
    }
    if(isset($arr_question['template45']['question2_1']) && $arr_question['template45']['question2_1']!=''){
      $str_options4 = $arr_question['template45']['answer2_1'];
      $arr_options4 = explode(',',$str_options4);
      $question4    = $arr_question['template45']['question2_1'];
    }
    if(isset($arr_question['template45']['question2_2']) && $arr_question['template45']['question2_2']!=''){
      $str_options5 = $arr_question['template45']['answer2_2'];
      $arr_options5 = explode(',',$str_options5);
      $question5    = $arr_question['template45']['question2_2'];
    }
    if(isset($arr_question['template45']['question2_3']) && $arr_question['template45']['question2_3']!=''){
      $str_options6 = $arr_question['template45']['answer2_3'];
      $arr_options6 = explode(',',$str_options6);
      $question6    = $arr_question['template45']['question2_3'];
    }
    $maxlength   = 0;
@endphp
...
<div class="middle-section temp-45-main-section">
        ...
        <div class="fill-in-the-blank-section">
            <div class="question-section">
                <div class="question-txt-section">
                    <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template45']['question']) && $arr_question['template45']['question']!='' ? ucwords($arr_question['template45']['question']) : "N/A" }}
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-mg-6 col-lg-6">
                    ...
                    <div class="game-fill-text-section">
                        <div class="fill-txt-section">
                            @if(isset($arr_question['template45']['question_1_file']) && $arr_question['template45']['question_1_file']!='')
                                @php $result = get_image_public_path($arr_question['template45']['question_1_file'],'image');  @endphp
                ...
                <div class="col-sm-6 col-mg-6 col-lg-6">
                    <div class="game-fill-text-section">
                        <div class="fill-txt-section">
                            @if(isset($arr_question['template45']['question_2_file']) && $arr_question['template45']['question_2_file']!='')
                                @php $result = get_image_public_path($arr_question['template45']['question_2_file'],'image');  @endphp
                                <img src="{{$result['image_url']}}" alt="tamplate seven" />
                            @endif
                            <div class="question-txt-secton">
                                @if(isset($arr_question['template45']['question2_1']) && $arr_question['template45']['question2_1']!='')
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="specker-mic-section" style="display: none">
                    <button onclick="togglePlay()" id="hornButton">
                        ...
                        <audio id="horn" src="{{$question_audio_public_path.$arr_question['template45']['horn']}}"></audio>
                    </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template45']['duration']));
            $minutes     = date('i',strtotime($arr_question['template45']['duration']));
            $seconds     = date('s',strtotime($arr_question['template45']['duration']));
        }
        $actual_time = $arr_question['template45']['duration'];
