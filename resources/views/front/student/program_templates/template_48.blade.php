...
@php
    $uniqid = uniqid();
    $arr_word     = str_split($arr_question['template48']['question_1'], 1);
    $arr_position = str_split($arr_question['template48']['answer_position'], 1);
@endphp
<!--middle section-->
<div class="middle-section temp-48-main-section">
        ...
        <div class="fill-in-the-blank-section">
            <div class="question-section">
                <div class="question-txt-section">
                    <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template48']['question']) && $arr_question['template48']['question']!='' ? ucwords($arr_question['template48']['question']) : "N/A" }}
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-mg-12 col-lg-12">
                    ...
                    <div class="game-img-section">
                        <div class="temp-41-ques-text">{{isset($arr_question['template48']['question']) && $arr_question['template48']['question']!='' ? ucwords($arr_question['template48']['question']) : "N/A" }}</div>
                        <div class="">
                            <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="specker-mic-section" style="display: none">
                    <button onclick="togglePlay()" id="hornButton">
                        ...
                        <audio id="horn" src="{{$question_audio_public_path.$arr_question['template48']['horn']}}"></audio>
                    </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template48']['duration']));
            $minutes     = date('i',strtotime($arr_question['template48']['duration']));
            $seconds     = date('s',strtotime($arr_question['template48']['duration']));
        }
        $actual_time = $arr_question['template48']['duration'];
