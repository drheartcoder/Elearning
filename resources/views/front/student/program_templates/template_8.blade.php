...
@php
    $uniqid = uniqid();
    $str_options = $arr_question['template8']['answer1'].','.$arr_question['template8']['answer2'];
...
@endphp
            ...
            <div class="fill-in-the-blank-section">
                <div class="question-section">
                    <div class="question-txt-section">
                        <i class="fa fa-angle-double-right"></i> {{isset($arr_question['template8']['question']) && $arr_question['template8']['question']!='' ? ucwords($arr_question['template8']['question'])." : " : "N/A" }} <br>
                ...
                @php
                    ...
                    {
                        $replace1    = '<input class="correct-ans" type="text" name="image1" maxlength="'.$maxlength.'" value="'.$arr_question['template8']['answer1'].'" disabled="true" />';
                        $replace2    = '<input class="correct-ans" type="text" name="image2" maxlength="'.$maxlength.'" value="'.$arr_question['template8']['answer2'].'" disabled="true" />';
                    }
                    else
                    {
                        $replace1    = '<input class="actual-ans questionCls" type="text" name="image1" maxlength="'.$maxlength.'" data-answer="'.$arr_question['template8']['answer1'].'" onkeyup="checkAnswer(this,event)" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />';
                        $replace2    = '<input class="actual-ans questionCls" type="text" name="image2" maxlength="'.$maxlength.'" data-answer="'.$arr_question['template8']['answer2'].'" onkeyup="checkAnswer(this,event)" onkeyup="checkAnswer(this,event)" ondrop="drop(event,this)" ondragover="allowDrop(event)" />';
                    }
                    $question1   = str_replace('#BLANK#',$replace1,$arr_question['template8']['question_1_text']);
                    $question2   = str_replace('#BLANK#',$replace2,$arr_question['template8']['question_2_text']);
                @endphp
                <div class="row">
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        ...
                        <div class="game-img-section">
                            @if(isset($arr_question['template8']['question_1_file']) && $arr_question['template8']['question_1_file']!='')
                                @php $result = get_image_public_path($arr_question['template8']['question_1_file'],'image');  @endphp
                    ...
                    <div class="col-sm-6 col-mg-6 col-lg-6">
                        <div class="game-fill-text-section">
                            @if(isset($arr_question['template8']['question_2_file']) && $arr_question['template8']['question_2_file']!='')
                                @php $result = get_image_public_path($arr_question['template8']['question_2_file'],'image');  @endphp
                                <img src="{{$result['image_url']}}" alt="tamplate seven" />
                            @endif
                            <div class="ques-ans-section-block">    
                                {!! $question2 !!}
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="specker-mic-section">
                        <button onclick="togglePlay()" id="hornButton">
                            ...
                            <audio id="horn" src="{{$question_audio_public_path.$arr_question['template8']['horn']}}"></audio>
                        </button>
    ...
    @php
        ...
        {
            $hours       = date('H',strtotime($arr_question['template8']['duration']));
            $minutes     = date('i',strtotime($arr_question['template8']['duration']));
            $seconds     = date('s',strtotime($arr_question['template8']['duration']));
        }
        $actual_time = $arr_question['template8']['duration'];
