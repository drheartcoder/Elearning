...
<div class="bredcrum-section-main">
    <div class="container">
        ...
        <div class="page-bredcrum-section">
            <ul>
                <li><a href="{{ url('/') }}/teacher/dashboard">Dashboard</a> &nbsp;&nbsp; <i class="fa fa-angle-right"></i> &nbsp;&nbsp; </li>
                <li>{{$pageTitle}}</li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-9 col-lg-9">
                           ...
                           <div class="col-sm-4 col-md-4 col-lg-4 pad-0">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pad-0">
                                <div class="report-block time-spent">
                                    <div class="icon-block">&nbsp;</div>
                                    <div class="text-block">
                                        <h2>{{date('i:s',strtotime($total_time))}} <span>Hrs</span></h2>
                                        <p>Time Spent</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                    ...
                    <div class="score-board">
                       <div class="score-title">Summative Assessment</div>
                        <div class="students-grade-section">
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block">
                                    ...
                                    <div class="std-points {{$reportB_class}}">
                                         <span>{{ $report_b_student_performace_points }}</span> Points
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Class Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_b_avg_class}}">{{ $report_b_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_b_class_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_b_class_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_b_class_average_low}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Global Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_b_global_class}}">{{ $report_b_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_b_global_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_b_global_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_b_global_average_low}}</span></li>
                                        </ul>
                    ...
                    <div class="score-board">
                       <div class="score-title">Quantitative Assessment</div>
                        <div class="students-grade-section">
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block">
                                    <h4>Performance Assessment</h4>
                                    ...
                                    <div class="std-points {{$reportC_class}}">
                                         <span>{{ $report_c_student_performace_points }}</span> Points
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Class Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_c_avg_class}}">{{ $report_c_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_c_class_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_c_class_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_c_class_average_low}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Global Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_c_global_class}}">{{ $report_c_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_c_global_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_c_global_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_c_global_average_low}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="score-board">
                       <div class="score-title">Challenge Program Assessment</div>
                        <div class="students-grade-section">
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block">
                                    <h4>Performance Assessment</h4>
                                    ...
                                    <div class="std-points {{$reportD_class}}">
                                         <span>{{ $report_d_student_performace_points }}</span> Points
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Class Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_d_avg_class}}">{{ $report_d_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_d_class_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_d_class_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_d_class_average_low}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 pad-0">
                                <div class="stud-grade-block avg-performance">
                                    <h4>Global Comparative Analysis</h4>
                                    <div class="grade-ring {{$report_d_global_class}}">{{ $report_d_student_performace_points }} <span>Points</span></div>
                                    <div class="grade-list">
                                        <ul>
                                            <li><span>High</span><div class="color-div light-green"></div><span>{{$report_d_global_average_high}}</span></li>
                                            <li><span>Average</span><div class="color-div orange"></div><span>{{$report_d_global_average_average}}</span></li>
                                            <li><span>Low</span><div class="color-div gray"></div><span>{{$report_d_global_average_low}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                      ...
                      <!-- <h4>Program Performance</h4> -->
                       <div class="row">
                           ...
                           <div class="col-sm-12 col-md-4 col-lg-4">
                               <div class="total-points">Total Points <h2>{{round($total_points)}}</h2></div>
                           </div>
                       </div>
<!--                        <div class="graph-info-list">
    ...
    <script type="text/javascript">
        ...
        $('.program_select').on('change',function(){
            ...
            if(program!='')
            {
                var redirect_url = SITE_URL+'/teacher/my-student/'+enc_class_id+'/program-report/'+program+'/'+enc_student_id;
