        ...
        <div class="container">            
            <div class="row">
                ...
                <div class="col-sm-8 col-md-9 col-lg-9">
                    ...
                    @endif
                    <!-- <form action="{{url('/teacher/print-class-report')}}" method="post">
                        {{csrf_field()}}
                    ...
                    <form action="{{url('/teacher/print-student-pin')}}" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="classid" id="classid" value="{{Request::segment(3)}}">
                        <div class="print-student-pins-main">
                            <div class="class-name-head-section">
                                {{trans('teacher.Print_Student_PINs')}}
                            </div>                        
                            <div class="cancel-print-buttons">
                                <!-- <a class="full-fill-button border-button sim-button-blue" data-dismiss="modal">Cancel</a> -->
                                <button type="submit" class="full-fill-button sim-button">{{ trans('parent.Print') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
