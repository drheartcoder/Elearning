    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-8 col-md-9 col-lg-9">
                <div class="my-profile-section teacher-noti"> 
                        ...
                        @foreach($arr_notifications['data'] as $notifications)
                            ...
                            <div class="notification-content">
                                <div class="noti-head-content">
                                    ...
                                    <button type="button" class="close-noti open_teacher_notification_popup" data-toggle="modal" data-target="#remove-notification" data-backdrop="static" data-keyboard="false" data-id="{{ $id }}"></button>
                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="form_delete_notification" method="post" action="{{ url('/') }}/teacher/notification/delete">
                    {{ csrf_field() }}
...
<script type="text/javascript">
    $(document).ready(function(){
        $(".open_notification_popup").click(function(){
            var id = $(this).data("id");
