...
<html>
    <head>
        <script src="{{url('/')}}/js/front/recording/js/jquery.js"></script>
        <script src="{{url('/')}}/js/front/recording/src/recorder.js"></script>
        <script src="{{url('/')}}/js/front/recording/src/Fr.voice.js"></script>
        <script src="{{url('/')}}/js/front/recording/js/jquery.js"></script>
        <script src="{{url('/')}}/js/front/recording/js/app.js"></script>
    </head>
    <body>
