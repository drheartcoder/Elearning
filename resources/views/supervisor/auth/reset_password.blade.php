			...
			<div class="page-header login-page header-filter" filter-color="black" style="background-image: url('../assets/img/class9.JPG'); background-size: cover; background-position: top center;">
				<div class="container">
					<div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
						<form action="{{url('/')}}/supervisor/forgot_password/postReset" method="post" id="frm_forgot" class="form form-validate">
						{{csrf_field()}}
...
<!--									<a href="{{url('/')}}/supervisor" class="btn btn-rose btn-link btn-lg">Back To Login</a>-->
								</div>
