      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-icon card-header-rose">
            ...
            <!-- <a class="btn btn-link btn-warning btn-just-icon like program-edit-btn lessonEdit" href="javascript:void(0);" title="Edit"><i class="material-icons" >create</i> <span>Edit</span></a> --> <div class="clearfix"></div>
          </div>
          <div class="card-body">
