                        ...
                        <div class="fill-txt-section">
                            <div class="alphabate-input" style="width: 100%;">
                                @foreach($arr_word as $key => $val)
                                    <input class="actual-ans questionCls" onkeyup="checkAnswer(this,event)" placeholder="{{$val}}" disabled="true" data-answer={{$val}} type="text" name="image name" style="width: 9%" maxlength="1" />
                                @endforeach
                            </div>
                        </div>
                    </div>
