...
@php
    $str_options = $arr_question['answer1'].','.$arr_question['answer3'].','.$arr_question['answer2'].','.$arr_question['answer4'].','.$arr_question['answer6'].','.$arr_question['answer5'];
                        ...
                        <div class="game-img-section temp-4-letter-section-div">
                            @if(isset($arr_question['question_1_file']) && $arr_question['question_1_file']!='')
                                @php $result = get_image_public_path($arr_question['question_1_file'],'image');  @endphp
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_1" data-answer="{{isset($arr_question['answer1']) && $arr_question['answer1']!='' ? $arr_question['answer1'] : 'N/A' }}" class="checkQuestion"/>
                            @endif
                        </div>
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        ...
                        @if(isset($arr_question['question_2_file']) && $arr_question['question_2_file']!='')
                           @php $result = get_image_public_path($arr_question['question_2_file'],'image');  @endphp
                                <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_2" data-answer="{{isset($arr_question['answer2']) && $arr_question['answer2']!='' ? $arr_question['answer2'] : 'N/A' }}" class="checkQuestion"/>
                        @endif                            
                        </div>
                        ...
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['question_3_file']) && $arr_question['question_3_file']!='')
                                @php $result = get_image_public_path($arr_question['question_3_file'],'image');  @endphp
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_3" data-answer="{{isset($arr_question['answer3']) && $arr_question['answer3']!='' ? $arr_question['answer3'] : 'N/A' }}" class="checkQuestion"/>
                            @endif
                        </div>
                    ...
                    <div class="col-sm-2 col-mg-2 col-lg-2">
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['question_4_file']) && $arr_question['question_4_file']!='')
                                ...
                                <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_4" data-answer="{{isset($arr_question['answer4']) && $arr_question['answer4']!='' ? $arr_question['answer4'] : 'N/A' }}" class="checkQuestion"/>
                            @endif
                        </div>
                        ...
                        <div class="game-img-section temp-4-letter-section-div">
                           @if(isset($arr_question['question_5_file']) && $arr_question['question_5_file']!='')
                                @php $result = get_image_public_path($arr_question['question_5_file'],'image');  @endphp
                                    <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_5" data-answer="{{isset($arr_question['answer5']) && $arr_question['answer5']!='' ? $arr_question['answer5'] : 'N/A' }}" class="checkQuestion"/>
                            @endif
                        </div>
                        ...
                        <div class="game-img-section temp-4-letter-section-div">
                            @if(isset($arr_question['question_6_file']) && $arr_question['question_6_file']!='')
                               @php $result = get_image_public_path($arr_question['question_6_file'],'image');  @endphp
                                <img src="{{$result['image_url']}}" alt="tamplate 13" id="question_6" data-answer="{{isset($arr_question['answer6']) && $arr_question['answer6']!='' ? $arr_question['answer6'] : 'N/A' }}" class="checkQuestion"/>
                            @endif
                        </div>
        ...
        setTimeout(function(){
            $('.checkAnswer').each(function(ans_index,ans_value){
                $('.checkQuestion').each(function(que_index,que_value){
                    if($(ans_value).data('answer')==$(que_value).data('answer'))
                    {
