...
@php
    $str_options = $arr_question['answer1'].','.$arr_question['answer2'].','.$arr_question['answer3'].','.$arr_question['answer4'].','.$arr_question['answer5'].','.$arr_question['answer6'];
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer1']}}" disabled="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer2']}}" disabled="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer3']}}" disabled="true" />
                                    </div>
                                </div>
                            </div>                                                            
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer4']}}" disabled="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer5']}}" disabled="true" />                                       
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-14-ans-section">                                        
                                         <input class="actual-ans uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" placeholder="{{$arr_question['answer6']}}" disabled="true" />
                                    </div>
                                </div>
                            </div>                                                                                     
                        </div>
