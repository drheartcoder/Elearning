    ...
    <div class="middle-section temp-8-main-section">
        <div class="container">
            <div class="fill-in-the-blank-section">
                ...
                @php
                    $replace1    = '<input class="actual-ans" type="text" name="image1" maxlength="'.$maxlength.'" placeholder="'.$arr_question['answer1'].'" disabled="true" />';
                    $replace2    = '<input class="actual-ans" type="text" name="image2" maxlength="'.$maxlength.'" placeholder="'.$arr_question['answer2'].'" disabled="true" />';
