        ...
        <div class="container">
            <div class="fill-in-the-blank-section">
                ...
                @php
                    ...
                    $arr_word3     = str_split($arr_question['question_3_text'], 1);
                    $arr_word4     = str_split($arr_question['question_4_text'], 1);
                    $arr_word5     = str_split($arr_question['question_5_text'], 1);
                    $arr_word6     = str_split($arr_question['question_6_text'], 1);
                    ...
                    $arr_position3 = str_split($arr_question['question_3_answer_position'], 1);
                    $arr_position4 = str_split($arr_question['question_4_answer_position'], 1);
                    $arr_position4 = str_split($arr_question['question_4_answer_position'], 1);
                    $arr_position5 = str_split($arr_question['question_5_answer_position'], 1);
                    $arr_position6 = str_split($arr_question['question_6_answer_position'], 1);
                @endphp 
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image1" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_1_answer']}}" disabled="true" /><span class="uppercase-style">{{$word1}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image2" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_2_answer']}}" disabled="true" /><span class="uppercase-style">{{$word2}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image3" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_3_answer']}}" disabled="true" /><span class="uppercase-style">{{$word3}}</span>
                                    </div>
                                </div>
                            </div>                                                            
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="game-img-section">                            
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image4" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_4_answer']}}" disabled="true" /><span class="uppercase-style">{{$word4}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section middle-img-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image5" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_5_answer']}}" disabled="true" /><span class="uppercase-style">{{$word5}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="display-table-section">
                                ...
                                <div class="col-sm-6 col-mg-6 col-lg-6 display-table-cell-section">
                                    <div class="ques-18-ans-section">                                        
                                            <input class="actual-ans uppercase-style" type="text" name="image6" maxlength="{{$maxlength}}" placeholder="{{$arr_question['question_6_answer']}}" disabled="true" /><span class="uppercase-style">{{$word6}}</span>
                                    </div>
                                </div>
                            </div>                                                                                     
                        </div>
