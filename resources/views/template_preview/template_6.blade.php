                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <div class="game-img-section">
                            @if(isset($arr_question['question_file']) && $arr_question['question_file']!='')
                                @php $result = get_image_public_path($arr_question['question_file'],'video');  @endphp
                            ...
                            <div class="fill-txt-section">
                                <div class="radio-btns">  
                                    <div class="radio-btn">
                                            ...
                                            <input type="radio" id="f-option" name="template6_checkbox" value="1" disabled="true" @if($arr_question['answer']==1) checked="true" @endif>
                                       
                                        <label for="f-option">{{isset($arr_question['option1']) && $arr_question['option1']!='' ? $arr_question['option1'] : "N/A"}}</label>
                                    </div>
                                    <div class="radio-btn">
                                   
                                            <input type="radio" id="s-option" name="template6_checkbox" value="2" disabled="true" @if($arr_question['answer']==2) checked="true" @endif>
