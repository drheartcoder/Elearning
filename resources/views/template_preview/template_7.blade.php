...
@php
    $str_options = $arr_question['answer1'].','.$arr_question['answer2'].','.$arr_question['answer3'].','.$arr_question['answer4'].','.$arr_question['answer5'];
                ...
                <div class="row">
                    <div class="col-5-custom">                        
                        ...
                        <div class="alphabate-input" style="width: 100%;">
                                ...
                                <input class="actual-ans" type="text" name="image1" style="width: 50%" maxlength="{{$maxlength}}" value="{{$arr_question['answer1']}}" disabled="true" />
                    ...
                    <div class="col-5-custom">
                        ...
                        <div class="alphabate-input" style="width: 100%;">                            
                                ...
                                <input class="actual-ans" type="text" name="image2" style="width: 50%" maxlength="{{$maxlength}}" value="{{$arr_question['answer2']}}" disabled="true" />
                    ...
                    <div class="col-5-custom">
                        ...
                        <div class="alphabate-input" style="width: 100%;">                            
                                ...
                                <input class="actual-ans" type="text" name="image3" style="width: 50%" maxlength="{{$maxlength}}" value="{{$arr_question['answer3']}}" disabled="true" />
                    ...
                    <div class="col-5-custom">
                        ...
                        <div class="alphabate-input" style="width: 100%;">                            
                                ...
                                <input class="actual-ans" type="text" name="image4" style="width: 50%" maxlength="{{$maxlength}}" value="{{$arr_question['answer4']}}" disabled="true" />
                    ...
                    <div class="col-5-custom">
                        ...
                        <div class="alphabate-input" style="width: 100%;">                            
                                ...
                                <input class="actual-ans" type="text" name="image5" style="width: 50%" maxlength="{{$maxlength}}" value="{{$arr_question['answer5']}}" disabled="true" />
